...
namespace NStore.PayPlugin.Tenpay
{
    /// <summary>
    /// TenpayUtil 的摘要说明。
    /// </summary>
    public class TenpayUtil
    {
        ...
        static TenpayUtil()
        {
            ...
            tenpay_return = string.Format("http://{0}/Tenpay/Return", NStore.Core.BMAConfig.MallConfig.SiteUrl); ;
            tenpay_notify = string.Format("http://{0}/Tenpay/Notify", NStore.Core.BMAConfig.MallConfig.SiteUrl);
        }
