...
namespace NStore.SearchStrategy.SqlServer
{
    /// <summary>
    /// 基于SqlServer的搜索策略
    /// </summary>
    public partial class SearchStrategy : ISearchStrategy
    {
        ...
        /// <param name="sortDirection">排序方向</param>
        /// <returns></returns>
        public List<StoreProductInfo> SearchMallProducts(List<int> ids, int pageSize, int pageNumber, int sortColumn, int sortDirection)
        {
            StringBuilder commandText = new StringBuilder();
