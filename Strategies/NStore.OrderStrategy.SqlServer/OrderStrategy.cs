...
namespace NStore.OrderStrategy.SqlServer
{
    /// <summary>
    /// 基于SqlServer的订单策略
    /// </summary>
    public partial class OrderStrategy : IOrderStrategy
    {
        ...
        public int CreateOrder(OrderInfo orderInfo, bool isPersistOrderProduct, List<OrderProductInfo> orderProductList)
        {
            DbParameter[] parms = {
                                        ...
                                        GenerateInParam("@invoicerise", SqlDbType.NVarChar,200 ,orderInfo.InvoiceRise??""),
                                        GenerateInParam("@invoiceaddress", SqlDbType.NVarChar,200 ,orderInfo.InvoiceAddress??""),
                                        GenerateInParam("@invoicemobile", SqlDbType.NVarChar,15 ,orderInfo.InvoiceMobile??""),
                                        GenerateInParam("@invoiceaccount", SqlDbType.NVarChar,50 ,orderInfo.InvoiceAccount??""),
                                        GenerateInParam("@invoicebank", SqlDbType.NVarChar,20 ,orderInfo.InvoiceBank??""),
                                        GenerateInParam("@invoicetaxid", SqlDbType.NVarChar,50 ,orderInfo.InvoiceTaxId??""),
                                    };
