...
namespace NStore.Services
{
    ...
    public partial class LoginFailLogs
    {
        ...
        {
            LoginFailLogInfo loginFailLogInfo = NStore.Data.LoginFailLogs.GetLoginFailLogByIP(CommonHelper.ConvertIPToLong(loginIP));
        ...
        {
            NStore.Data.LoginFailLogs.AddLoginFailTimes(CommonHelper.ConvertIPToLong(loginIP), loginTime);
        }
        ...
        {
            NStore.Data.LoginFailLogs.DeleteLoginFailLogByIP(CommonHelper.ConvertIPToLong(loginIP));
        }
    }
}
