...
namespace NStore.Services
{
    ...
    public partial class ProductReviews
    {
        ...
        {
            return NStore.Data.ProductReviews.GetProductReviewById(reviewId);
        }
        ...
        {
            NStore.Data.ProductReviews.ReviewProduct(productReviewInfo);
        }
        ...
        {
            NStore.Data.ProductReviews.VoteProductReview(reviewId, uid, voteTime);
        }
        ...
        {
            return NStore.Data.ProductReviews.IsVoteProductReview(reviewId, uid);
        }
        ...
        public static bool ChangeProductReviewState(int reviewId, int state)
        {
            if (reviewId > 0 && (state == 0 || state == 1))
                return NStore.Data.ProductReviews.ChangeProductReviewState(reviewId, state);
            return false;
        }
        ...
        {
            return NStore.Data.ProductReviews.GetUserProductReviewList(uid, pageSize, pageNumber);
        }
        ...
        {
            return NStore.Data.ProductReviews.GetUserProductReviewCount(uid);
        }
        ...
        {
            return NStore.Data.ProductReviews.GetProductReviewList(pid, type, pageSize, pageNumber);
        }
        ...
        {
            return NStore.Data.ProductReviews.GetProductReviewCount(pid, type);
        }
        ...
        {
            return NStore.Data.ProductReviews.GetProductReviewWithReplyById(reviewId);
        }
        ...
        {
            return NStore.Data.ProductReviews.GetProductReviewList(startTime, endTime);
        }
    }
}
