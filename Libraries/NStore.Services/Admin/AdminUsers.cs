...
namespace NStore.Services
{
    ...
    public partial class AdminUsers : Users
    {
        ...
        {
            return NStore.Data.Users.AdminGetUserList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Users.AdminGetUserListCondition(userName, email, mobile, userRid, mallAGid);
        }
        ...
        {
            return NStore.Data.Users.AdminGetUserListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Users.AdminGetUserCount(condition);
        }
        ...
        {
            NStore.Data.Users.SetStoreAdminer(uid, storeId);
        }
    }
}
