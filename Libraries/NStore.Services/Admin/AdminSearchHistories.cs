...
namespace NStore.Services
{
    public partial class AdminSearchHistories : SearchHistories
    {
        ...
        {
            return NStore.Data.SearchHistories.GetSearchWordStatList(pageSize, pageNumber, word, sort);
        }
        ...
        {
            return NStore.Data.SearchHistories.GetSearchWordStatListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.SearchHistories.GetSearchWordStatCount(word);
        }
    }
}
