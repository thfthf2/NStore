...
namespace NStore.Services
{
    ...
    public partial class AdminProductConsults : ProductConsults
    {
        ...
        {
            NStore.Data.ProductConsults.UpdateProductConsultType(productConsultTypeInfo);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST);
        }
        ...
        public static int DeleteProductConsultTypeById(int consultTypeId)
        {
            ...
            NStore.Data.ProductConsults.DeleteProductConsultTypeById(consultTypeId);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST);
            return 1;
        }
        ...
        {
            if (consultId > 0)
                return NStore.Data.ProductConsults.AdminGetProductConsultById(consultId);
            return null;
        }
        ...
        {
            return NStore.Data.ProductConsults.AdminGetProductConsultList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.ProductConsults.AdminGetProductConsultListCondition(consultTypeId, storeId, pid, uid, consultMessage, consultStartTime, consultEndTime);
        }
        ...
        {
            return NStore.Data.ProductConsults.AdminGetProductConsultListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.ProductConsults.AdminGetProductConsultCount(condition);
        }
        ...
        public static DataTable GetStoreIdListByConsultId(int[] consultIdList)
        {
            if (consultIdList != null && consultIdList.Length > 0)
                return NStore.Data.ProductConsults.GetStoreIdListByConsultId(CommonHelper.IntArrayToString(consultIdList));
