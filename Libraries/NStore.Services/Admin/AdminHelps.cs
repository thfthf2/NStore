...
namespace NStore.Services
{
    ...
    public partial class AdminHelps : Helps
    {
        ...
        {
            NStore.Data.Helps.CreateHelp(helpInfo);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_HELP_LIST);
        }
        ...
        public static int DeleteHelpById(int id)
        {
            ...
            if (helpInfo != null)
            {
                ...
                NStore.Data.Helps.DeleteHelpById(id);
                NStore.Core.BMACache.Remove(CacheKeys.MALL_HELP_LIST);
                return 1;
            }
            return 0;
        ...
        {
            NStore.Data.Helps.UpdateHelp(helpInfo);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_HELP_LIST);
        }
        ...
        public static bool UpdateHelpDisplayOrder(int id, int displayOrder)
        {
            ...
            if (id > 1)
            {
                result = NStore.Data.Helps.UpdateHelpDisplayOrder(id, displayOrder);
                if (result)
                    NStore.Core.BMACache.Remove(CacheKeys.MALL_HELP_LIST);
            }
