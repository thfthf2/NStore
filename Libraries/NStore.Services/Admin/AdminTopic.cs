...
namespace NStore.Services
{
    ...
    public partial class AdminTopic : Topics
    {
        ...
        public static void DeleteTopicById(int topicId)
        {
            ...
            if (topicInfo != null)
            {
                NStore.Data.Topics.DeleteTopicById(topicId);
                NStore.Core.BMACache.Remove(CacheKeys.MALL_TOPIC_INFO + topicInfo.TopicId);
                NStore.Core.BMACache.Remove(CacheKeys.MALL_TOPIC_INFO + topicInfo.SN);
            }
        }
        ...
        {
            if (topicId > 0)
                return NStore.Data.Topics.AdminGetTopicById(topicId);
            return null;
        }
        ...
        {
            return NStore.Data.Topics.AdminGetTopicListCondition(sn, title, startTime, endTime);
        }
        ...
        {
            return NStore.Data.Topics.AdminGetTopicListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Topics.AdminGetTopicList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Topics.AdminGetTopicCount(condition);
        }
    }
}
