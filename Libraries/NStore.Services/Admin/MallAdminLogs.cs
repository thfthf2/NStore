...
namespace NStore.Services
{
    ...
    public partial class MallAdminLogs
    {
        ...
        public static void CreateMallAdminLog(int uid, string nickName, int mallAGid, string mallAGTitle, string ip, string operation, string description)
        {
            ...
            NStore.Data.MallAdminLogs.CreateMallAdminLog(adminOperateLogInfo);
        }
        ...
        {
            return NStore.Data.MallAdminLogs.GetMallAdminLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Data.MallAdminLogs.GetMallAdminLogListCondition(uid, operation, startTime, endTime);
        }
        ...
        {
            return NStore.Data.MallAdminLogs.GetMallAdminLogCount(condition);
        }
        ...
        public static void DeleteMallAdminLogById(int[] logIdList)
        {
            if (logIdList != null && logIdList.Length > 0)
                NStore.Data.MallAdminLogs.DeleteMallAdminLogById(CommonHelper.IntArrayToString(logIdList));
        }
    }
}
