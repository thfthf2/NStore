...
namespace NStore.Services
{
    ...
    public partial class AdminOrderRefunds : OrderRefunds
    {
        ...
        {
            NStore.Data.OrderRefunds.RefundOrder(refundId, refundSN, refundSystemName, refundFriendName, refundTime);
        }
        ...
        {
            return NStore.Data.OrderRefunds.GetOrderRefundList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Data.OrderRefunds.GetOrderRefundListCondition(storeId, osn);
        }
        ...
        {
            return NStore.Data.OrderRefunds.GetOrderRefundCount(condition);
        }
    }
}
