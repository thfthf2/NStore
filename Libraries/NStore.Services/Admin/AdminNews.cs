...
namespace NStore.Services
{
    ...
    public partial class AdminNews : News
    {
        ...
        {
            NStore.Data.News.DeleteNewsTypeById(newsTypeId);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWSTYPE_LIST);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWS_HOMELIST + "\\d+");
        }
        ...
        {
            NStore.Data.News.UpdateNewsType(newsTypeInfo);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWSTYPE_LIST);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWS_HOMELIST + "\\d+");
        }
        ...
        {
            NStore.Data.News.CreateNews(newsInfo);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWS_HOMELIST + newsInfo.NewsTypeId);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWS_HOMELIST + "\\d+");
        }
        ...
        public static void DeleteNewsById(int[] newsIdList)
        {
            ...
            {
                NStore.Data.News.DeleteNewsById(CommonHelper.IntArrayToString(newsIdList));
                NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWS_HOMELIST + "\\d+");
            }
        }
        ...
        {
            NStore.Data.News.UpdateNews(newsInfo);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWS_HOMELIST + newsInfo.NewsTypeId);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NEWS_HOMELIST + "\\d+");
        }
        ...
        {
            if (newsId > 0)
                return NStore.Data.News.AdminGetNewsById(newsId);
            return null;
        }
        ...
        {
            return NStore.Data.News.AdminGetNewsList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.News.AdminGetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return NStore.Data.News.AdminGetNewsListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.News.AdminGetNewsCount(condition);
        }
        ...
        public static int AdminGetNewsIdByTitle(string title)
        {
            if (string.IsNullOrWhiteSpace(title))
                return 0;
            return NStore.Data.News.AdminGetNewsIdByTitle(title);
        }
    }
}
