...
namespace NStore.Services
{
    ...
    public partial class AdminProducts : Products
    {
        ...
        {
            return NStore.Data.Products.CreateProduct(productInfo);
        }
        ...
        {
            NStore.Data.Products.UpdateProduct(productInfo);
        }
        ...
        {
            return NStore.Data.Products.AdminGetProductListCondition(storeId, storeCid, productName, cateId, brandId, state);
        }
        ...
        {
            return NStore.Data.Products.AdminGetProductListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Products.AdminGetProductList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Products.AdminGetProductCount(condition);
        }
        ...
        {
            if (pid < 1) return null;
            return NStore.Data.Products.AdminGetPartProductById(pid);
        }
        ...
        public static void DeleteProductById(int[] pidList)
        {
            if (pidList != null && pidList.Length > 0)
                NStore.Data.Products.DeleteProductById(CommonHelper.IntArrayToString(pidList));
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return NStore.Data.Products.UpdateProductState(CommonHelper.IntArrayToString(pidList), state);
            return false;
        }
        ...
        public static bool UpdateProductDisplayOrder(int pid, int displayOrder)
        {
            ...
            return NStore.Data.Products.UpdateProductDisplayOrder(pid, displayOrder);
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return NStore.Data.Products.ChangeProductIsNew(CommonHelper.IntArrayToString(pidList), isNew);
            return false;
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return NStore.Data.Products.ChangeProductIsHot(CommonHelper.IntArrayToString(pidList), isHot);
            return false;
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return NStore.Data.Products.ChangeProductIsBest(CommonHelper.IntArrayToString(pidList), isBest);
            return false;
        }
        ...
        public static bool UpdateProductShopPrice(int pid, decimal shopPrice)
        {
            ...
            return NStore.Data.Products.UpdateProductShopPrice(pid, shopPrice);
        ...
        {
            NStore.Data.Products.UpdateProductShowImage(pid, showImg);
        }
        ...
        public static int AdminGetProductIdByName(string name)
        {
            if (string.IsNullOrWhiteSpace(name))
                return -1;
            return NStore.Data.Products.AdminGetProductIdByName(name);
        }
        ...
        {
            return NStore.Data.Products.AdminGetBrandProductCount(brandId);
        }
        ...
        {
            return NStore.Data.Products.AdminGetCategoryProductCount(cateId);
        }
        ...
        {
            return NStore.Data.Products.AdminGetAttrValueProductCount(attrValueId);
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return NStore.Data.Products.GetStoreIdListByPid(CommonHelper.IntArrayToString(pidList));
        ...
        {
            return NStore.Data.Products.AdminGetStoreProductCount(storeId);
        }
        ...
        {
            return NStore.Data.Products.AdminGetStoreClassProductCount(storeCid);
        }
        ...
        {
            return NStore.Data.Products.AdminGetStoreShipTemplateProductCount(storeSTid);
        }
        ...
        public static bool UpdateProductAttribute(ProductAttributeInfo productAttributeInfo)
        {
            if (productAttributeInfo.Pid < 1 || productAttributeInfo.AttrId < 1 || productAttributeInfo.AttrValueId < 0 || (productAttributeInfo.AttrValueId == 0 && string.IsNullOrWhiteSpace(productAttributeInfo.InputValue)))
                return false;
            return NStore.Data.Products.UpdateProductAttribute(productAttributeInfo);
        }
        ...
        {
            if (pid > 0 && attrId > 0)
                return NStore.Data.Products.DeleteProductAttributeByPidAndAttrId(pid, attrId);
            return false;
        }
        ...
        {
            NStore.Data.Products.CreateProductSKUItem(productSKUItemInfo);
        }
        ...
        {
            return NStore.Data.Products.IsExistSKUGid(skuGid);
        }
        ...
        public static bool DeleteProductImageById(int pImgId)
        {
            ...
            bool result = NStore.Data.Products.DeleteProductImageById(productImageInfo.Pid, pImgId);
        ...
        public static bool SetProductMainImage(int pImgId)
        {
            ...
            {
                result = NStore.Data.Products.SetProductMainImage(productImageInfo.Pid, pImgId);
                if (result)
        ...
        public static bool ChangeProductImageDisplayOrder(int pImgId, int displayOrder)
        {
            ...
            if (productImageInfo != null)
                return NStore.Data.Products.ChangeProductImageDisplayOrder(productImageInfo.Pid, pImgId, displayOrder);
            return false;
        }
        ...
        {
            return NStore.Data.Products.CreateProductImage(productImageInfo);
        }
        ...
        public static ProductImageInfo GetProductImageById(int pImgId)
        {
            ...
            return NStore.Data.Products.GetProductImageById(pImgId);
        }
        ...
        {
            return NStore.Data.Products.CreateProductStock(pid, number, limit);
        }
        ...
        {
            NStore.Data.Products.UpdateProductStock(pid, number, limit);
        }
        ...
        {
            return NStore.Data.Products.UpdateProductStockNumber(pid, number);
        }
        ...
        {
            NStore.Data.Products.CreateProductKeyword(productKeywordInfo);
        }
        ...
        public static bool DeleteProductKeyword(int[] keywordIdList)
        {
            if (keywordIdList != null && keywordIdList.Length > 0)
                return NStore.Data.Products.DeleteProductKeyword(CommonHelper.IntArrayToString(keywordIdList));
            return false;
        }
        ...
        {
            return NStore.Data.Products.GetProductKeywordList(pid);
        }
        ...
        {
            return NStore.Data.Products.IsExistProductKeyword(pid, keyword);
        }
        ...
        {
            return NStore.Data.Products.UpdateProductKeywordRelevancy(keywordId, relevancy);
        }
        ...
        {
            return NStore.Data.Products.GetPidByKeywordId(keywordId);
        }
        ...
        {
            if (keywordIdList != null && keywordIdList.Length > 0)
                return NStore.Data.Products.GetStoreIdListByKeywordId(CommonHelper.IntArrayToString(keywordIdList));
            return null;
        }
        ...
        {
            NStore.Data.Products.AddRelateProduct(pid, relatePid);
        }
        ...
        {
            return NStore.Data.Products.DeleteRelateProductByPidAndRelatePid(pid, relatePid);
        }
        ...
        {
            return NStore.Data.Products.IsExistRelateProduct(pid, relatePid);
        }
        ...
        {
            return NStore.Data.Products.AdminGetRelateProductList(pid);
        }
        ...
        {
            return NStore.Data.Products.GetTimeProductList(type);
        }
        ...
        {
            return NStore.Data.Products.GetTimeProductList(pageSize, pageNumber, storeId, productName);
        }
        ...
        {
            return NStore.Data.Products.GetTimeProductCount(storeId, productName);
        }
        ...
        {
            return NStore.Data.Products.GetTimeProductByRecordId(recordId);
        }
        ...
        public static bool IsExistTimeProduct(int pid)
        {
            if (pid < 1)
                return false;
            return NStore.Data.Products.IsExistTimeProduct(pid);
        }
        ...
        {
            NStore.Data.Products.DeleteTimeProductByRecordId(recordId);
        }
    }
}
