...
namespace NStore.Services
{
    ...
    public partial class AdminBrands : Brands
    {
        ...
        {
            return NStore.Data.Brands.AdminGetBrandListCondition(brandName);
        }
        ...
        {
            return NStore.Data.Brands.AdminGetBrandListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Brands.AdminGetBrandList(pageSize, pageNumber, condition, sort);
        }
        ...
        public static int DeleteBrandById(int brandId)
        {
            if (AdminProducts.AdminGetBrandProductCount(brandId) > 0)
                return 0;
            NStore.Data.Brands.DeleteBrandById(brandId);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_BRAND_INFO + brandId);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_BRAND_CATEGORYLIST + brandId);
            return 1;
        }
        ...
        {
            return NStore.Data.Brands.AdminGetBrandCount(condition);
        }
        ...
        {
            return NStore.Data.Brands.AdminGetBrandSelectList(pageSize, pageNumber, condition);
        }
    }
}
