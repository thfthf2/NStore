...
namespace NStore.Services
{
    ...
    public partial class AdminCredits : Credits
    {
        ...
        {
            return NStore.Data.Credits.AdminGetCreditLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Data.Credits.AdminGetCreditLogListCondition(uid, startTime, endTime);
        }
        ...
        {
            return NStore.Data.Credits.AdminGetCreditLogCount(condition);
        }
