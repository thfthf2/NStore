...
namespace NStore.Services
{
    ...
    public partial class AdminCoupons : Coupons
    {
        ...
        public static void DeleteCouponTypeById(int[] couponTypeIdList)
        {
            ...
            {
                //删除优惠劵类型
                NStore.Data.Coupons.DeleteCouponTypeById(CommonHelper.IntArrayToString(couponTypeIdList));

                //删除优惠劵类型缓存
                foreach (int couponTypeId in couponTypeIdList)
                {
                    NStore.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_INFO + couponTypeId);
                    NStore.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_SENDCOUNT + couponTypeId);
                }
            }
        }
        ...
        public static CouponTypeInfo AdminGetCouponTypeById(int couponTypeId)
        {
            ...
            return NStore.Data.Coupons.AdminGetCouponTypeById(couponTypeId);
        }
        ...
        {
            return NStore.Data.Coupons.AdminGetCouponTypeListCondition(storeId, type, couponTypeName);
        }
        ...
        {
            return NStore.Data.Coupons.AdminGetCouponTypeList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Data.Coupons.AdminGetCouponTypeCount(condition);
        }
        ...
        {
            bool result = NStore.Data.Coupons.ChangeCouponTypeState(couponTypeId, state);
            if (result)
            {
                NStore.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_INFO + couponTypeId);
                NStore.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_SENDCOUNT + couponTypeId);
        ...
        {
            if (couponTypeIdList != null && couponTypeIdList.Length > 0)
                return NStore.Core.BMAData.RDBS.GetStoreIdListByCouponTypeId(CommonHelper.IntArrayToString(couponTypeIdList));
        ...
        {
            return NStore.Data.Coupons.AdminGetCouponListCondition(sn, uid, couponTypeId);
        }
        ...
        {
            return NStore.Data.Coupons.AdminGetCouponList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Data.Coupons.AdminGetCouponCount(condition);
        }
        ...
        public static DataTable GetStoreIdListByCouponId(int[] couponIdList)
        {
            if (couponIdList != null && couponIdList.Length > 0)
                return NStore.Core.BMAData.RDBS.GetStoreIdListByCouponId(CommonHelper.IntArrayToString(couponIdList));
            return new DataTable();
        }
        ...
        public static void AddCouponProduct(int couponTypeId, int pid)
        {
            if (couponTypeId > 0 && pid > 0)
                NStore.Data.Coupons.AddCouponProduct(couponTypeId, pid);
        }
        ...
        public static bool DeleteCouponProductByRecordId(int[] recordIdList)
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return NStore.Data.Coupons.DeleteCouponProductByRecordId(CommonHelper.IntArrayToString(recordIdList));
            return false;
        }
        ...
        {
            return NStore.Data.Coupons.AdminGetCouponProductList(pageSize, pageNumber, couponTypeId);
        }
        ...
        {
            return NStore.Data.Coupons.AdminGetCouponProductCount(couponTypeId);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return NStore.Core.BMAData.RDBS.GetStoreIdListByCouponProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }
