...
namespace NStore.Services
{
    ...
    public partial class StoreAdminLogs
    {
        ...
        public static void CreateStoreAdminLog(int uid, string nickName, int storeId, string storeName, string ip, string operation, string description)
        {
            ...
            NStore.Data.StoreAdminLogs.CreateStoreAdminLog(storeAdminLogInfo);
        }
        ...
        {
            return NStore.Data.StoreAdminLogs.GetStoreAdminLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Data.StoreAdminLogs.GetStoreAdminLogListCondition(storeId, operation, startTime, endTime);
        }
        ...
        {
            return NStore.Data.StoreAdminLogs.GetStoreAdminLogCount(condition);
        }
        ...
        public static void DeleteStoreAdminLogById(int[] logIdList)
        {
            if (logIdList != null && logIdList.Length > 0)
                NStore.Data.StoreAdminLogs.DeleteStoreAdminLogById(CommonHelper.IntArrayToString(logIdList));
        }
    }
}
