...
namespace NStore.Services
{
    ...
    public partial class AdminOrders : Orders
    {
        ...
        {
            return NStore.Data.Orders.GetOrderList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Orders.GetOrderListCondition(storeId, osn, uid, consignee, orderState);
        }
        ...
        {
            return NStore.Data.Orders.GetOrderListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Orders.GetOrderCount(condition);
        }
        ...
        {
            return NStore.Data.Orders.GetSaleProductList(pageSize, pageNumber, startTime, endTime);
        }
        ...
        {
            return NStore.Data.Orders.GetSaleProductCount(startTime, endTime);
        }
        ...
        {
            return NStore.Data.Orders.GetSaleTrend(trendType, timeType, startTime, endTime);
        }
    }
}
