...
namespace NStore.Services
{
    ...
    public partial class AdminCategories : Categories
    {
        ...
        public static void UpdateCategory(CategoryInfo categoryInfo, int oldParentId)
        {
            ...
            {
                int changeLayer = 0;
                List<CategoryInfo> categoryList = NStore.Data.Categories.GetCategoryList();
                ...
                if (categoryInfo.ParentId > 0)//非顶层分类时
                {
                    ...
                    if (newParentCategoryInfo.HasChild == 0)
                    {
                        ...
                        NStore.Data.Categories.UpdateCategory(newParentCategoryInfo);
                    }
                }
                else//顶层分类时
                {
                ...
                if (oldParentId > 0 && categoryList.FindAll(x => x.ParentId == oldParentId).Count == 1)
                {
                    ...
                    NStore.Data.Categories.UpdateCategory(oldParentCategoryInfo);
                }
            ...
            NStore.Data.Categories.UpdateCategory(categoryInfo);

            NStore.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_LIST);
        ...
        public static void CreateCategory(CategoryInfo categoryInfo)
        {
            if (categoryInfo.ParentId > 0)
            {
                ...
                categoryInfo.Path = "";
                int categoryId = NStore.Data.Categories.CreateCategory(categoryInfo);
                ...
                if (parentCategoryInfo.HasChild == 0)
                {
                    ...
                    NStore.Data.Categories.UpdateCategory(parentCategoryInfo);
                }
            }
            else
            {
        ...
        public static int DeleteCategoryById(int cateId)
        {
            ...
            NStore.Data.Categories.DeleteCategoryById(cateId);
            ...
            NStore.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_LIST);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_BRANDLIST + cateId);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + cateId);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + cateId);
        ...
        {
            NStore.Data.Categories.UpdateAttributeGroup(attributeGroupInfo);
        }
        ...
        public static int DeleteAttributeGroupById(int attrGroupId)
        {
            if (GetAttributeListByAttrGroupId(attrGroupId).Count > 0)
                return 0;
            NStore.Data.Categories.DeleteAttributeGroupById(attrGroupId);
            return 1;
        }
        ...
        {
            return NStore.Data.Categories.AdminGetAttributeListSort(sortColumn, sortDirection);
        }
