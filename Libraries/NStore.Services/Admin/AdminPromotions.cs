...
namespace NStore.Services
{
    ...
    public partial class AdminPromotions : Promotions
    {
        ...
        public static SinglePromotionInfo AdminGetSinglePromotionById(int pmId)
        {
            ...
            return NStore.Data.Promotions.AdminGetSinglePromotionById(pmId);
        }
        ...
        {
            NStore.Data.Promotions.CreateSinglePromotion(singlePromotionInfo);
        }
        ...
        public static void DeleteSinglePromotionById(int[] pmIdList)
        {
            if (pmIdList != null && pmIdList.Length > 0)
                NStore.Data.Promotions.DeleteSinglePromotionById(CommonHelper.IntArrayToString(pmIdList));
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetSinglePromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetSinglePromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetSinglePromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetSinglePromotionCount(condition);
        }
        ...
        {
            return NStore.Data.Promotions.AdminIsExistSinglePromotion(pid, startTime, endTime);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListBySinglePmId(CommonHelper.IntArrayToString(pmIdList));
        ...
        {
            return NStore.Data.Promotions.GetSinglePromotionPidList(pmIdList);
        }
        ...
        {
            if (pmId < 1) return null;
            return NStore.Data.Promotions.AdminGetBuySendPromotionById(pmId);
        }
        ...
        {
            NStore.Data.Promotions.CreateBuySendPromotion(buySendPromotionInfo);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                NStore.Data.Promotions.DeleteBuySendPromotionById(CommonHelper.IntArrayToString(pmIdList));
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetBuySendPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetBuySendPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetBuySendPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetBuySendPromotionCount(condition);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListByBuySendPmId(CommonHelper.IntArrayToString(pmIdList));
            return new DataTable();
        }
        ...
        {
            if (pmId > 0 && pid > 0)
                NStore.Data.Promotions.AddBuySendProduct(pmId, pid);
        }
        ...
        public static bool DeleteBuySendProductByRecordId(int[] recordIdList)
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return NStore.Data.Promotions.DeleteBuySendProductByRecordId(CommonHelper.IntArrayToString(recordIdList));
            return false;
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetBuySendProductList(pageSize, pageNumber, pmId, pid);
        }
        ...
        {
            if (pmId < 1) return 0;
            return NStore.Data.Promotions.AdminGetBuySendProductCount(pmId, pid);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListByBuySendProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }
        ...
        {
            return NStore.Data.Promotions.GetBuySendPidList(recordIdList);
        }
        ...
        {
            if (pmId < 1) return null;
            return NStore.Data.Promotions.AdminGetGiftPromotionById(pmId);
        }
        ...
        {
            NStore.Data.Promotions.CreateGiftPromotion(giftPromotionInfo);
        }
        ...
        {
            NStore.Data.Promotions.UpdateGiftPromotion(giftPromotionInfo);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                NStore.Data.Promotions.DeleteGiftPromotionById(CommonHelper.IntArrayToString(pmIdList));
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetGiftPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetGiftPromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetGiftPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetGiftPromotionCount(condition);
        }
        ...
        {
            return NStore.Data.Promotions.AdminIsExistGiftPromotion(pid, startTime, endTime);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListByGiftPmId(CommonHelper.IntArrayToString(pmIdList));
            return new DataTable();
        }
        ...
        {
            return NStore.Data.Promotions.GetGiftPromotionPidList(pmIdList);
        }
        ...
        {
            NStore.Data.Promotions.AddGift(pmId, giftId, number, pid);
        }
        ...
        {
            return NStore.Data.Promotions.DeleteGiftByPmIdAndGiftId(pmId, giftId);
        }
        ...
        {
            if (number > 0)
                return NStore.Data.Promotions.UpdateGiftNumber(pmId, giftId, number);
            return false;
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetExtGiftList(pmId);
        }
        ...
        {
            if (pmId < 1) return null;
            return NStore.Data.Promotions.AdminGetSuitPromotionById(pmId);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                NStore.Data.Promotions.DeleteSuitPromotionById(CommonHelper.IntArrayToString(pmIdList));
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetSuitPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetSuitPromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetSuitPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetSuitPromotionCount(condition);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListBySuitPmId(CommonHelper.IntArrayToString(pmIdList));
            return new DataTable();
        }
        ...
        public static void AddSuitProduct(int pmId, int pid, int discount, int number)
        {
            if (pmId > 0 && pid > 0 && discount > -1 && number > 0)
                NStore.Data.Promotions.AddSuitProduct(pmId, pid, discount, number);
        }
        ...
        {
            return NStore.Data.Promotions.DeleteSuitProductByPmIdAndPid(pmId, pid);
        }
        ...
        {
            if (number > 0)
                return NStore.Data.Promotions.UpdateSuitProductNumber(pmId, pid, number);
            return false;
        }
        ...
        {
            if (discount > 0)
                return NStore.Data.Promotions.UpdateSuitProductDiscount(pmId, pid, discount);
            return false;
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetExtSuitProductList(pmId);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetAllExtSuitProductList(pmIdList);
        }
        ...
        {
            if (pmId < 1) return null;
            return NStore.Data.Promotions.AdminGetFullSendPromotionById(pmId);
        }
        ...
        {
            NStore.Data.Promotions.CreateFullSendPromotion(fullSendPromotionInfo);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                NStore.Data.Promotions.DeleteFullSendPromotionById(CommonHelper.IntArrayToString(pmIdList));
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullSendPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullSendPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullSendPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullSendPromotionCount(condition);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListByFullSendPmId(CommonHelper.IntArrayToString(pmIdList));
            return new DataTable();
        }
        ...
        public static void AddFullSendProduct(int pmId, int pid, int type)
        {
            if (pmId > 0 && pid > 0 && (type == 0 || type == 1))
                NStore.Data.Promotions.AddFullSendProduct(pmId, pid, type);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return NStore.Data.Promotions.DeleteFullSendProductByRecordId(CommonHelper.IntArrayToString(recordIdList));
            return false;
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullSendProductList(pageSize, pageNumber, pmId, type);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullSendProductCount(pmId, type);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListByFullSendProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }
        ...
        {
            return NStore.Data.Promotions.GetFullSendProductList(recordIdList);
        }
        ...
        {
            if (pmId < 1) return null;
            return NStore.Data.Promotions.AdminGetFullCutPromotionById(pmId);
        }
        ...
        {
            NStore.Data.Promotions.CreateFullCutPromotion(fullCutPromotionInfo);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                NStore.Data.Promotions.DeleteFullCutPromotionById(CommonHelper.IntArrayToString(pmIdList));
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullCutPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullCutPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullCutPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullCutPromotionCount(condition);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListByFullCutPmId(CommonHelper.IntArrayToString(pmIdList));
            return new DataTable();
        }
        ...
        {
            if (pmId > 0 && pid > 0)
                NStore.Data.Promotions.AddFullCutProduct(pmId, pid);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return NStore.Data.Promotions.DeleteFullCutProductByRecordId(CommonHelper.IntArrayToString(recordIdList));
            return false;
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullCutProductList(pageSize, pageNumber, pmId);
        }
        ...
        {
            return NStore.Data.Promotions.AdminGetFullCutProductCount(pmId);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return NStore.Data.Promotions.GetStoreIdListByFullCutProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }
        ...
        {
            return NStore.Data.Promotions.GetFullCutPidList(recordIdList);
        }
    }
}