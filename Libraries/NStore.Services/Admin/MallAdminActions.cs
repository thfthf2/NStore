...
namespace NStore.Services
{
    public partial class MallAdminActions
    {
        ...
        {
            return NStore.Data.MallAdminActions.GetMallAdminActionList();
        }
        ...
        {
            HashSet<string> actionHashSet = NStore.Core.BMACache.Get(CacheKeys.MALL_MALLADMINACTION_HASHSET) as HashSet<string>;
            if (actionHashSet == null)
            {
                ...
                NStore.Core.BMACache.Insert(CacheKeys.MALL_MALLADMINACTION_HASHSET, actionHashSet);
            }
