...
namespace NStore.Services
{
    ...
    public partial class AdminNavs : Navs
    {
        ...
        public static void CreateNav(NavInfo navInfo)
        {
            ...
            NStore.Data.Navs.CreateNav(navInfo);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NAV_LIST);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NAV_MAINLIST);
        }
        ...
        public static int DeleteNavById(int id)
        {
            ...
            NStore.Data.Navs.DeleteNavById(id);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NAV_LIST);
            NStore.Core.BMACache.Remove(CacheKeys.MALL_NAV_MAINLIST);
            return 1;
        }
        ...
        public static void UpdateNav(NavInfo navInfo, int oldPid)
        {
            ...
            NStore.Data.Navs.UpdateNav(navInfo);
