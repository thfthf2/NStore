...
namespace NStore.Services
{
    ...
    public partial class Users
    {
        ...
        {
            if (uid > 0)
                return NStore.Data.Users.GetPartUserById(uid);
        ...
        {
            if (uid > 0)
                return NStore.Data.Users.GetUserById(uid);
        ...
        {
            if (uid > 0)
                return NStore.Data.Users.GetUserDetailById(uid);
        ...
        {
            return NStore.Data.Users.GetPartUserByName(userName);
        }
        ...
        {
            return NStore.Data.Users.GetPartUserByEmail(email);
        }
        ...
        {
            return NStore.Data.Users.GetPartUserByMobile(mobile);
        }
        ...
        public static int GetUidByUserName(string userName)
        {
            ...
            return NStore.Data.Users.GetUidByUserName(userName);
        }
        ...
        public static int GetUidByEmail(string email)
        {
            ...
            return NStore.Data.Users.GetUidByEmail(email);
        }
        ...
        public static int GetUidByMobile(string mobile)
        {
            ...
            return NStore.Data.Users.GetUidByMobile(mobile);
        }
        ...
        {
            return NStore.Data.Users.CreateUser(userInfo);
        }
        ...
        {
            NStore.Data.Users.UpdateUser(userInfo);
        }
        ...
        {
            NStore.Data.Users.UpdateUserLastVisit(uid, visitTime, ip, regionId);
        }
        ...
        public static void DeleteUserById(int[] uidList)
        {
            ...
            if (uidList != null && uidList.Length > 0)
                NStore.Data.Users.DeleteUserById(CommonHelper.IntArrayToString(uidList));
        }
        ...
        {
            return NStore.Data.Users.GetUserCountByUserRid(userRid);
        }
        ...
        {
            return NStore.Data.Users.GetUserCountByMallAGid(mallAGid);
        }
        ...
        {
            return NStore.Data.Users.UpdateUser(uid, userName, nickName, avatar, gender, realName, bday, idCard, regionId, address, bio);
        }
        ...
        {
            NStore.Data.Users.UpdateUserEmailByUid(uid, email);
        }
        ...
        {
            NStore.Data.Users.UpdateUserMobileByUid(uid, mobile);
        }
        ...
        {
            NStore.Data.Users.UpdateUserPasswordByUid(uid, password);
        }
        ...
        {
            NStore.Data.Users.UpdateUserLiftBanTimeByUid(uid, liftBanTime);
        }
        ...
        {
            NStore.Data.Users.UpdateUserRankByUid(uid, userRid);
        }
        ...
        public static void UpdateUserOnlineTime(int uid)
        {
            ...
            {
                NStore.Data.Users.UpdateUserOnlineTime(uid, updateOnlineTimeSpan, DateTime.Now);
        ...
        {
            return NStore.Data.Users.GetRegisterTimeByRegisterIP(registerIP);
        }
        ...
        {
            return NStore.Data.Users.GetUserLastVisitTimeByUid(uid);
        }
        ...
        {
            return NStore.Data.Users.GetStoreAdminerIdByStoreId(storeId);
        }
    }
}
