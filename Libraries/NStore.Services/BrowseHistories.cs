...
namespace NStore.Services
{
    ...
    public partial class BrowseHistories
    {
        ...
        {
            return NStore.Data.BrowseHistories.GetUserBrowseProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return NStore.Data.BrowseHistories.GetUserBrowseProductCount(uid);
        }
        ...
        public static void UpdateBrowseHistory(object state)
        {
            ...
            NStore.Data.BrowseHistories.UpdateBrowseHistory(updateBrowseHistoryState.Uid, updateBrowseHistoryState.Pid, updateBrowseHistoryState.UpdateTime);
        }
        ...
        {
            NStore.Data.BrowseHistories.ClearExpiredBrowseHistory();
        }
    }
}
