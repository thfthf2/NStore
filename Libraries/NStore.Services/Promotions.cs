...
namespace NStore.Services
{
    ...
    public partial class Promotions
    {
        ...
        {
            return NStore.Data.Promotions.GetSinglePromotionByPidAndTime(pid, nowTime);
        }
        ...
        {
            return NStore.Data.Promotions.GetSinglePromotionProductBuyCount(uid, pmId);
        }
        ...
        {
            NStore.Data.Promotions.UpdateSinglePromotionStock(singlePromotionList);
        }
        ...
        {
            return NStore.Data.Promotions.GetBuySendPromotionList(storeId, pid, nowTime);
        }
        ...
        {
            return NStore.Data.Promotions.IsExistBuySendProduct(pmId, pid);
        }
        ...
        {
            return NStore.Data.Promotions.GetAllBuySendPromotion(storeId, nowTime);
        }
        ...
        {
            return NStore.Data.Promotions.GetGiftPromotionByPidAndTime(pid, buyTime);
        }
        ...
        {
            return NStore.Data.Promotions.IsExistGift(pmId, giftId);
        }
        ...
        {
            return NStore.Data.Promotions.GetExtGiftList(pmId);
        }
        ...
        {
            if (pmId > 0)
                return NStore.Data.Promotions.GetSuitPromotionByPmIdAndTime(pmId, nowTime);
            return null;
        }
        ...
        {
            return NStore.Data.Promotions.IsJoinSuitPromotion(uid, pmId);
        }
        ...
        {
            return NStore.Data.Promotions.GetSuitPromotionList(pid, nowTime);
        }
        ...
        {
            return NStore.Data.Promotions.IsExistSuitProduct(pmId, pid);
        }
        ...
        {
            return NStore.Data.Promotions.GetExtSuitProductList(pmId);
        }
        ...
        {
            return NStore.Data.Promotions.GetAllExtSuitProductList(pmIdList);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullSendPromotionByStoreIdAndPidAndTime(storeId, pid, nowTime);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullSendPromotionByPmIdAndTime(pmId, nowTime);
        }
        ...
        {
            return NStore.Data.Promotions.IsExistFullSendProduct(pmId, pid);
        }
        ...
        {
            return NStore.Data.Promotions.IsExistFullSendProduct(pmId, pid, type);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullSendMainProductList(pageSize, pageNumber, pmId, startPrice, endPrice, sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullSendMainProductCount(pmId, startPrice, endPrice);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullSendPresentList(pmId);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullCutPromotionByStoreIdAndPidAndTime(storeId, pid, nowTime);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullCutPromotionByStoreIdAndPmIdAndTime(storeId, pmId, nowTime);
        }
        ...
        {
            if (pmId > 0 && pid > 0)
                return NStore.Data.Promotions.IsExistFullCutProduct(pmId, pid);
            return false;
        }
        ...
        {
            return NStore.Data.Promotions.GetAllFullCutPromotion(storeId, nowTime);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullCutProductList(pageSize, pageNumber, fullCutPromotionInfo, startPrice, endPrice, sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Promotions.GetFullCutProductCount(fullCutPromotionInfo, startPrice, endPrice);
        }
