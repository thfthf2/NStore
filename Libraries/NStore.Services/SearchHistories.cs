...
namespace NStore.Services
{
    ...
    public partial class SearchHistories
    {
        ...
        public static void UpdateSearchHistory(object state)
        {
            ...
            NStore.Data.SearchHistories.UpdateSearchHistory(updateSearchHistoryState.Uid, updateSearchHistoryState.Word, updateSearchHistoryState.UpdateTime);
        }
        ...
        {
            NStore.Data.SearchHistories.ClearExpiredSearchHistory();
        }
    }
}
