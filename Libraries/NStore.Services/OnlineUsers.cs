...
namespace NStore.Services
{
    ...
    public partial class OnlineUsers
    {
        ...
        public static int CreateOnlineMember(int uid, string sid, string nickName, DateTime updateTime, string ip, int regionId)
        {
            ...
            int olid = NStore.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
        ...
        public static int CreateOnlineGuest(string sid, DateTime updateTime, string ip, int regionId)
        {
            ...
            return NStore.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
        }
        ...
        {
            NStore.Data.OnlineUsers.UpdateOnlineUserIP(olId, ip);
        }
        ...
        {
            NStore.Data.OnlineUsers.UpdateOnlineUserUid(olId, uid);
        }
        ...
        {
            return NStore.Data.OnlineUsers.GetOnlineUserBySid(sid);
        }
        ...
        {
            return NStore.Data.OnlineUsers.GetOnlineUserCount(userType);
        }
        ...
        public static int GetOnlineUserCount()
        {
            ...
            int onlineAllUserCount = TypeHelper.ObjectToInt(NStore.Core.BMACache.Get(CacheKeys.MALL_ONLINEUSER_ALLUSERCOUNT), -1);
            if (onlineAllUserCount == -1)
            {
                onlineAllUserCount = GetOnlineUserCount(0);
                NStore.Core.BMACache.Insert(CacheKeys.MALL_ONLINEUSER_ALLUSERCOUNT, onlineAllUserCount);
            }
        ...
        public static int GetOnlineGuestCount()
        {
            ...
            int onlineGuestCount = TypeHelper.ObjectToInt(NStore.Core.BMACache.Get(CacheKeys.MALL_ONLINEUSER_GUESTCOUNT), -1);
            if (onlineGuestCount == -1)
            {
                onlineGuestCount = GetOnlineUserCount(-1);
                NStore.Core.BMACache.Insert(CacheKeys.MALL_ONLINEUSER_GUESTCOUNT, onlineGuestCount);
            }
        ...
        {
            NStore.Data.OnlineUsers.DeleteOnlineUserBySid(sid);
        }
        ...
        public static void DeleteExpiredOnlineUser()
        {
            ...
            {
                NStore.Data.OnlineUsers.DeleteExpiredOnlineUser(BMAConfig.MallConfig.OnlineUserExpire);
        ...
        public static void ResetOnlineUserTable()
        {
            try
            {
                NStore.Data.OnlineUsers.ResetOnlineUserTable();
            }
            catch
            {
                try
        ...
        {
            return NStore.Data.OnlineUsers.GetOnlineUserList(pageSize, pageNumber, locationType, locationId, sort);
        }
        ...
        {
            return NStore.Data.OnlineUsers.GetOnlineUserListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.OnlineUsers.GetOnlineUserCount(locationType, locationId);
        }
    }
}
