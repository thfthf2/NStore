...
namespace NStore.Services
{
    ...
    public partial class FilterWords
    {
        ...
        {
            return NStore.Data.FilterWords.GetFilterWordList();
        }
        ...
        {
            object[,] filterWordRegexList = NStore.Core.BMACache.Get(CacheKeys.MALL_FILTERWORD_REGEXLIST) as object[,];
            if (filterWordRegexList == null)
            {
                ...
                NStore.Core.BMACache.Insert(CacheKeys.MALL_FILTERWORD_REGEXLIST, filterWordRegexList);
            }
