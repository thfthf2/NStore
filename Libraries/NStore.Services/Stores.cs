...
namespace NStore.Services
{
    ...
    public partial class Stores
    {
        ...
        {
            return NStore.Data.Stores.GetStoreReviewByOid(oid);
        }
        ...
        {
            return NStore.Data.Stores.SumStoreReview(storeId, startTime, endTime);
        }
        ...
        public static StoreInfo GetStoreById(int storeId)
        {
            ...
            return NStore.Data.Stores.GetStoreById(storeId);
        }
        ...
        public static int GetStoreIdByName(string storeName)
        {
            if (string.IsNullOrWhiteSpace(storeName))
                return 0;
            return NStore.Data.Stores.GetStoreIdByName(storeName);
        }
        ...
        {
            NStore.Data.Stores.UpdateStorePoint(storeId, dePoint, sePoint, shPoint);
        }
        ...
        {
            return NStore.Data.Stores.GetStoreIdList();
        }
        ...
        {
            return NStore.Data.Stores.GetStoreKeeperById(storeId);
        }
        ...
        {
            List<StoreClassInfo> storeClassList = NStore.Core.BMACache.Get(CacheKeys.MALL_STORE_CLASSLIST + storeId) as List<StoreClassInfo>;
            if (storeClassList == null)
            {
                storeClassList = new List<StoreClassInfo>();
                List<StoreClassInfo> sourceStoreClassList = NStore.Data.Stores.GetStoreClassList(storeId);
                CreateStoreClassTree(sourceStoreClassList, storeClassList, 0);
                NStore.Core.BMACache.Insert(CacheKeys.MALL_STORE_CLASSLIST + storeId, storeClassList);
            }
        ...
        {
            return NStore.Data.Stores.GetStoreShipFeeByStoreSTidAndRegion(storeSTId, provinceId, cityId);
        }
    }
}
