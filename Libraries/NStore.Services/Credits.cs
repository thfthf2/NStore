...
namespace NStore.Services
{
    ...
    public partial class Credits
    {
        ...
        {
            NStore.Data.Credits.SendCredits(userRid, creditLogInfo);
        }
        ...
        {
            return NStore.Data.Credits.GetPayCreditLogList(uid, type, pageSize, pageNumber);
        }
        ...
        {
            return NStore.Data.Credits.GetPayCreditLogCount(uid, type);
        }
        ...
        {
            return NStore.Data.Credits.GetTodaySendPayCredits(uid, today);
        }
        ...
        {
            return NStore.Data.Credits.GetTodaySendRankCredits(uid, today);
        }
        ...
        {
            return NStore.Data.Credits.IsSendTodayLoginCredit(uid, today);
        }
        ...
        {
            return NStore.Data.Credits.IsSendCompleteUserInfoCredit(uid);
        }
        ...
        {
            return NStore.Data.Credits.GetUserOrderSendCredits(oid);
        }
    }
}
