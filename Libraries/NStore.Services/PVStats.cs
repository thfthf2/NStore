...
namespace NStore.Services
{
    ...
    public partial class PVStats
    {
        ...
        {
            NStore.Data.PVStats.UpdatePVStat((UpdatePVStatState)updatePVStatState);
        }
        ...
        {
            return NStore.Data.PVStats.GetProvinceRegionStat();
        }
        ...
        {
            return NStore.Data.PVStats.GetCityRegionStat(provinceId);
        }
        ...
        {
            return NStore.Data.PVStats.GetCountyRegionStat(cityId);
        }
        ...
        {
            return NStore.Data.PVStats.GetPVStatList(condition);
        }
        ...
        {
            return NStore.Data.PVStats.GetPVStatByCategoryAndValue(category, value);
        }
