...
namespace NStore.Services
{
    ...
    public partial class FavoriteProducts
    {
        ...
        {
            return NStore.Data.FavoriteProducts.AddProductToFavorite(uid, pid, state, addTime);
        }
        ...
        {
            return NStore.Data.FavoriteProducts.DeleteFavoriteProductByUidAndPid(uid, pid);
        }
        ...
        {
            return NStore.Data.FavoriteProducts.IsExistFavoriteProduct(uid, pid);
        }
        ...
        {
            return NStore.Data.FavoriteProducts.GetFavoriteProductList(pageSize, pageNumber, uid, storeName, productName);
        }
        ...
        {
            return NStore.Data.FavoriteProducts.GetFavoriteProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return NStore.Data.FavoriteProducts.GetFavoriteProductCount(uid, storeName, productName);
        }
        ...
        {
            return NStore.Data.FavoriteProducts.GetFavoriteProductCount(uid);
        }
        ...
        {
            return NStore.Data.FavoriteProducts.SetFavoriteProductState(uid, pid, state);
        }
    }
}
