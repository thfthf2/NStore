...
namespace NStore.Services
{
    ...
    public partial class StoreRanks
    {
        ...
        {
            List<StoreRankInfo> storeRankList = NStore.Core.BMACache.Get(CacheKeys.MALL_STORE_RANKLIST) as List<StoreRankInfo>;
            if (storeRankList == null)
            {
                storeRankList = NStore.Data.StoreRanks.GetStoreRankList();
                NStore.Core.BMACache.Insert(CacheKeys.MALL_STORE_RANKLIST, storeRankList);
            }
