...
namespace NStore.Services
{
    ...
    public partial class ShipAddresses
    {
        ...
        {
            return NStore.Data.ShipAddresses.GetFullShipAddressList(uid);
        }
        ...
        {
            return NStore.Data.ShipAddresses.GetShipAddressCount(uid);
        }
        ...
        {
            return NStore.Data.ShipAddresses.GetDefaultFullShipAddress(uid);
        }
        ...
        public static FullShipAddressInfo GetFullShipAddressBySAId(int saId, int uid)
        {
            ...
            FullShipAddressInfo fullShipAddressInfo = NStore.Data.ShipAddresses.GetFullShipAddressBySAId(uid, saId);
        ...
        public static ShipAddressInfo GetShipAddressBySAId(int saId, int uid)
        {
            ...
            ShipAddressInfo shipAddressInfo = NStore.Data.ShipAddresses.GetShipAddressBySAId(uid, saId);
        ...
        public static bool DeleteShipAddress(int saId, int uid)
        {
            if (saId < 1)
                return false;
            return NStore.Data.ShipAddresses.DeleteShipAddress(saId, uid);
        }
        ...
        public static bool UpdateShipAddressIsDefault(int saId, int uid, int isDefault)
        {
            ...
            return NStore.Data.ShipAddresses.UpdateShipAddressIsDefault(saId, uid, isDefault);
        }
    }
}
