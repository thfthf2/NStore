...
namespace NStore.Services
{
    ...
    public partial class Coupons
    {
        ...
        {
            return NStore.Data.Coupons.GetSendingPromotionCouponTypeList(storeId);
        }
        ...
        {
            return NStore.Data.Coupons.GetSendingCouponTypeList(storeId, nowTime);
        }
        ...
        {
            return NStore.Data.Coupons.GetUsingCouponTypeList(storeId, nowTime);
        }
        ...
        {
            NStore.Data.Coupons.CreateCoupon(couponInfo);
        }
        ...
        public static void DeleteCouponById(int[] idList)
        {
            if (idList != null && idList.Length > 0)
                NStore.Data.Coupons.DeleteCouponById(CommonHelper.IntArrayToString(idList));
        }
        ...
        {
            NStore.Data.Coupons.DeleteCouponById(idList);
        }
        ...
        {
            return NStore.Data.Coupons.IsExistCouponSN(couponSN);
        }
        ...
        {
            int sendCount = TypeHelper.ObjectToInt(NStore.Core.BMACache.Get(CacheKeys.MALL_COUPONTYPE_SENDCOUNT + couponTypeId), -1);
            if (sendCount < 0)
            {
                sendCount = NStore.Data.Coupons.GetSendCouponCount(couponTypeId);
                NStore.Core.BMACache.Insert(CacheKeys.MALL_COUPONTYPE_SENDCOUNT + couponTypeId, sendCount);
            }
        ...
        {
            return NStore.Data.Coupons.GetSendUserCouponCount(uid, couponTypeId);
        }
        ...
        {
            return NStore.Data.Coupons.GetTodaySendUserCouponCount(uid, couponTypeId, today);
        }
        ...
        {
            return NStore.Data.Coupons.GetCouponList(uid, 0);
        }
        ...
        {
            DataTable dt = NStore.Data.Coupons.GetCouponList(uid, 1);
            if (dt.Rows.Count < 1)
                return dt;
        ...
        {
            return NStore.Data.Coupons.GetCouponList(uid, 2);
        }
        ...
        {
            return NStore.Data.Coupons.GetCouponByCouponId(couponId);
        }
        ...
        {
            return NStore.Data.Coupons.GetCouponByCouponSN(couponSN);
        }
        ...
        public static string PullCoupon(PartUserInfo partUserInfo, CouponTypeInfo couponTypeInfo, DateTime pullTime, string pullIP)
        {
            ...
            NStore.Core.BMACache.Insert(CacheKeys.MALL_COUPONTYPE_SENDCOUNT + couponTypeInfo.CouponTypeId, sendCount + 1);
        ...
        {
            NStore.Data.Coupons.UseCoupon(couponId, oid, time, ip);
        }
        ...
        {
            NStore.Data.Coupons.ActivateAndUseCoupon(couponId, uid, oid, time, ip);
        }
        ...
        {
            NStore.Data.Coupons.ActivateCoupon(couponId, uid, time, ip);
        }
        ...
        {
            NStore.Data.Coupons.ReturnUserOrderUseCoupons(oid);
        }
        ...
        {
            return NStore.Data.Coupons.GetUserOrderSendCouponList(oid);
        }
        ...
        {
            return NStore.Data.Coupons.IsExistCouponProduct(couponTypeId, pid);
        }
        ...
        {
            return NStore.Data.Coupons.IsSameCouponType(couponTypeId, pidList);
        }
    }
}
