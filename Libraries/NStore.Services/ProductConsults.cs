...
namespace NStore.Services
{
    ...
    public partial class ProductConsults
    {
        ...
        {
            ProductConsultTypeInfo[] productConsultTypeList = NStore.Core.BMACache.Get(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST) as ProductConsultTypeInfo[];
            if (productConsultTypeList == null)
            {
                productConsultTypeList = NStore.Data.ProductConsults.GetProductConsultTypeList();
                NStore.Core.BMACache.Insert(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST, productConsultTypeList);
            }
        ...
        {
            NStore.Data.ProductConsults.ConsultProduct(pid, consultTypeId, consultUid, storeId, consultTime, consultMessage, consultNickName, pName, pShowImg, consultIP);
        }
        ...
        {
            NStore.Data.ProductConsults.ReplyProductConsult(consultId, replyUid, replyTime, replyMessage, replyNickName, replyIP);
        }
        ...
        {
            if (consultId > 0)
                return NStore.Data.ProductConsults.GetProductConsultById(consultId);
            return null;
        }
        ...
        public static void DeleteProductConsultById(int[] consultIdList)
        {
            if (consultIdList != null && consultIdList.Length > 0)
                NStore.Data.ProductConsults.DeleteProductConsultById(CommonHelper.IntArrayToString(consultIdList));
        }
        ...
        public static bool UpdateProductConsultState(int consultId, int state)
        {
            if (consultId > 0 && (state == 0 || state == 1))
                return NStore.Data.ProductConsults.UpdateProductConsultState(consultId, state);
            return false;
        }
        ...
        {
            return NStore.Data.ProductConsults.GetProductConsultList(pageSize, pageNumber, pid, consultTypeId, consultMessage);
        }
        ...
        {
            return NStore.Data.ProductConsults.GetProductConsultCount(pid, consultTypeId, consultMessage);
        }
        ...
        {
            return NStore.Data.ProductConsults.GetUserProductConsultList(uid, pageSize, pageNumber);
        }
        ...
        {
            return NStore.Data.ProductConsults.GetUserProductConsultCount(uid);
        }
    }
}
