...
namespace NStore.Services
{
    ...
    public partial class FavoriteStores
    {
        ...
        {
            return NStore.Data.FavoriteStores.AddStoreToFavorite(uid, storeId, addTime);
        }
        ...
        {
            return NStore.Data.FavoriteStores.DeleteFavoriteStoreByUidAndStoreId(uid, storeId);
        }
        ...
        {
            return NStore.Data.FavoriteStores.IsExistFavoriteStore(uid, storeId);
        }
        ...
        {
            return NStore.Data.FavoriteStores.GetFavoriteStoreList(pageSize, pageNumber, uid);
        }
        ...
        {
            return NStore.Data.FavoriteStores.GetFavoriteStoreCount(uid);
        }
    }
}
