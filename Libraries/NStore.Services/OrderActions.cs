...
namespace NStore.Services
{
    ...
    public partial class OrderActions
    {
        ...
        {
            NStore.Data.OrderActions.CreateOrderAction(orderActionInfo);
        }
        ...
        {
            return NStore.Data.OrderActions.GetOrderActionList(oid);
        }
        ...
        {
            return NStore.Data.OrderActions.GetOrderIdList(startTime, endTime, orderActionType);
        }
    }
}
