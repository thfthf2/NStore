...
namespace NStore.Services
{
    ...
    public partial class Products
    {
        ...
        public static ProductInfo GetProductById(int pid)
        {
            ...
            return NStore.Data.Products.GetProductById(pid);
        }
        ...
        {
            if (pid < 1) return null;
            return NStore.Data.Products.GetPartProductById(pid);
        }
        ...
        public static List<PartProductInfo> GetPartProductList(string pidList)
        {
            ...
            return NStore.Data.Products.GetPartProductList(pidList);
        }
        ...
        {
            return NStore.Data.Products.GetProductShadowVisitCountById(pid);
        }
        ...
        {
            NStore.Data.Products.UpdateProductShadowVisitCount(pid, visitCount);
        }
        ...
        {
            NStore.Data.Products.AddProductShadowSaleCount(pid, saleCount);
        }
        ...
        {
            NStore.Data.Products.AddProductShadowReviewCount(pid, starType);
        }
        ...
        {
            return NStore.Data.Products.GetCategoryProductList(pageSize, pageNumber, cateId, brandId, filterPrice, catePriceRangeList, attrValueIdList, onlyStock, sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Products.GetCategoryProductCount(cateId, brandId, filterPrice, catePriceRangeList, attrValueIdList, onlyStock);
        }
        ...
        {
            return NStore.Data.Products.GetStoreClassProductList(pageSize, pageNumber, storeCid, startPrice, endPrice, sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Data.Products.GetStoreClassProductCount(storeCid, startPrice, endPrice);
        }
        ...
        {
            List<PartProductInfo> storeTraitProductList = NStore.Core.BMACache.Get(string.Format(CacheKeys.MALL_PRODUCT_STORETRAITLIST, count, storeId, storeCid, trait)) as List<PartProductInfo>;
            if (storeTraitProductList == null)
            {
                storeTraitProductList = NStore.Data.Products.GetStoreTraitProductList(count, storeId, storeCid, trait);
                NStore.Core.BMACache.Insert(string.Format(CacheKeys.MALL_PRODUCT_STORETRAITLIST, count, storeId, storeCid, trait), storeTraitProductList);
            }
        ...
        {
            List<PartProductInfo> storeSaleProductList = NStore.Core.BMACache.Get(string.Format(CacheKeys.MALL_PRODUCT_STORESALELIST, count, storeId, storeCid)) as List<PartProductInfo>;
            if (storeSaleProductList == null)
            {
                storeSaleProductList = NStore.Data.Products.GetStoreSaleProductList(count, storeId, storeCid);
                NStore.Core.BMACache.Insert(string.Format(CacheKeys.MALL_PRODUCT_STORESALELIST, count, storeId, storeCid), storeSaleProductList);
            }
        ...
        {
            return NStore.Data.Products.GetProductSummaryList(pidList);
        }
        ...
        {
            return NStore.Data.Products.GetProductAttributeByPidAndAttrId(pid, attrId);
        }
        ...
        {
            return NStore.Data.Products.GetProductAttributeList(pid);
        }
        ...
        {
            return NStore.Data.Products.GetExtProductAttributeList(pid);
        }
        ...
        {
            return NStore.Data.Products.GetProductSKUItemList(pid);
        }
        ...
        {
            if (skuGid > 0)
                return NStore.Data.Products.GetProductSKUListBySKUGid(skuGid);
        ...
        {
            if (pid > 0)
                return NStore.Data.Products.GetProductImageList(pid);
        ...
        {
            return NStore.Data.Products.GetProductStockByPid(pid);
        }
        ...
        {
            return NStore.Data.Products.GetProductStockNumberByPid(pid);
        }
        ...
        {
            NStore.Data.Products.IncreaseProductStockNumber(orderProductList);
        }
        ...
        {
            NStore.Data.Products.DecreaseProductStockNumber(orderProductList);
        }
        ...
        {
            if (!string.IsNullOrEmpty(pidList))
                return NStore.Data.Products.GetProductStockList(pidList);
