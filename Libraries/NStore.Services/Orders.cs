...
namespace NStore.Services
{
    ...
    public partial class Orders
    {
        ...
        {
            if (oid > 0)
                return NStore.Data.Orders.GetOrderByOid(oid);
            else
                return null;
        }
        ...
        public static OrderInfo GetOrderByOSN(string osn)
        {
            if (!string.IsNullOrWhiteSpace(osn))
                return NStore.Data.Orders.GetOrderByOSN(osn);
            return null;
        }
        ...
        {
            return NStore.Data.Orders.GetOrderCountByCondition(storeId, orderState, startTime, endTime);
        }
        ...
        {
            return NStore.Data.Orders.GetOrderProductList(oid);
        }
        ...
        public static List<OrderProductInfo> GetOrderProductList(string oidList)
        {
            if (!string.IsNullOrEmpty(oidList))
                return NStore.Data.Orders.GetOrderProductList(oidList);
        ...
        {
            NStore.Data.Orders.UpdateOrderDiscount(oid, discount, surplusMoney);
        }
        ...
        {
            NStore.Data.Orders.UpdateOrderShipFee(oid, shipFee, orderAmount, surplusMoney);
        }
        ...
        {
            NStore.Data.Orders.PayOrder(oid, orderState, paySN, payTime);
        }
        ...
        {
            NStore.Data.Orders.SendOrderProduct(oid, orderState, shipSN, shipCoId, shipCoName, shipTime);
        }
        ...
        {
            NStore.Data.Orders.UpdateOrderState(oid, orderState);
        }
        ...
        {
            NStore.Data.Orders.UpdateOrderIsReview(oid, isReview);
        }
        ...
        {
            return NStore.Data.Orders.GetUserOrderList(uid, pageSize, pageNumber, startAddTime, endAddTime, orderState);
        }
        ...
        {
            return NStore.Data.Orders.GetUserOrderCount(uid, startAddTime, endAddTime, orderState);
        }
