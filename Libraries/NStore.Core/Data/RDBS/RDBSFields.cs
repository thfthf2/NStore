...
namespace NStore.Core
{
    ...
    public partial class RDBSFields
    {
        ...
        /// 属性值表
        /// </summary>
        public const string ATTRIBUTE_VALUES = "[attrvalueid],[attrvalue],[attrvaluedisplayorder],[attrid],[attrname],[attrshowtype],[attrdisplayorder],[attrgroupid],[attrgroupname],[attrgroupdisplayorder]"; //,[state]
        ...
        /// 订单商品表
        /// </summary>
        public const string ORDER_PRODUCTS = "[recordid],[oid],[uid],[sid],[pid],[psn],[cateid],[brandid],[storeid],[storecid],[storestid],[name],[showimg],[discountprice],[shopprice],[costprice],[marketprice],[weight],[isreview],[realcount],[buycount],[sendcount],[type],[paycredits],[coupontypeid],[extcode1],[extcode2],[extcode3],[extcode4],[extcode5],[addtime]";
