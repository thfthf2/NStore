...
namespace NStore.Data
{
    ...
    public partial class Products
    {
        ...
        {
            int pid = NStore.Core.BMAData.RDBS.CreateProduct(productInfo);
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateProduct(productInfo);
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteProductById(pidList);
            if (_productnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductListCondition(storeId, storeCid, productName, cateId, brandId, state);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductCount(condition);
        }
        ...
        public static ProductInfo AdminGetProductById(int pid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetProductById(pid);
            if (reader.Read())
            {
        ...
        public static PartProductInfo AdminGetPartProductById(int pid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetPartProductById(pid);
            if (reader.Read())
            {
        ...
        public static ProductInfo GetProductById(int pid)
        {
            ...
            {
                IDataReader reader = NStore.Core.BMAData.RDBS.GetProductById(pid);
                if (reader.Read())
                {
                    productInfo = BuildProductFromReader(reader);
                }
        ...
        public static PartProductInfo GetPartProductById(int pid)
        {
            ...
            {
                IDataReader reader = NStore.Core.BMAData.RDBS.GetPartProductById(pid);
                if (reader.Read())
                {
                    partProductInfo = BuildPartProductFromReader(reader);
                }
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateProductState(pidList, state);
            if (_productnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateProductDisplayOrder(pid, displayOrder);
            if (_productnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.ChangeProductIsNew(pidList, isNew);
            if (_productnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.ChangeProductIsBest(pidList, isBest);
            if (_productnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateProductShopPrice(pid, shopPrice);
            if (_productnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateProductShowImage(pid, showImg);
            if (_productnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductIdByName(name);
        }
        ...
        public static List<PartProductInfo> GetPartProductList(string pidList)
        {
            ...
            else
            {
                ...
                IDataReader reader = NStore.Core.BMAData.RDBS.GetPartProductList(pidList);
                while (reader.Read())
                {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProductShadowVisitCountById(pid);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateProductShadowVisitCount(pid, visitCount);
            if (_productnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.AddProductShadowSaleCount(pid, saleCount);
            if (_productnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.AddProductShadowReviewCount(pid, starType);
            if (_productnosql != null)
        ...
        public static List<StoreProductInfo> GetCategoryProductList(int pageSize, int pageNumber, int cateId, int brandId, int filterPrice, string[] catePriceRangeList, List<int> attrValueIdList, int onlyStock, int sortColumn, int sortDirection)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetCategoryProductList(pageSize, pageNumber, cateId, brandId, filterPrice, catePriceRangeList, attrValueIdList, onlyStock, sortColumn, sortDirection);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetCategoryProductCount(cateId, brandId, filterPrice, catePriceRangeList, attrValueIdList, onlyStock);
        }
        ...
        public static List<PartProductInfo> GetStoreClassProductList(int pageSize, int pageNumber, int storeCid, int startPrice, int endPrice, int sortColumn, int sortDirection)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreClassProductList(pageSize, pageNumber, storeCid, startPrice, endPrice, sortColumn, sortDirection);
            while (reader.Read())
            {
                PartProductInfo partProductInfo = BuildPartProductFromReader(reader);
                partProductList.Add(partProductInfo);
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreClassProductCount(storeCid, startPrice, endPrice);
        }
        ...
        public static List<PartProductInfo> GetStoreTraitProductList(int count, int storeId, int storeCid, int trait)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreTraitProductList(count, storeId, storeCid, trait);
            while (reader.Read())
            {
                PartProductInfo partProductInfo = BuildPartProductFromReader(reader);
                partProductList.Add(partProductInfo);
        ...
        public static List<PartProductInfo> GetStoreSaleProductList(int count, int storeId, int storeCid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreSaleProductList(count, storeId, storeCid);
            while (reader.Read())
            {
                PartProductInfo partProductInfo = BuildPartProductFromReader(reader);
                partProductList.Add(partProductInfo);
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProductSummaryList(pidList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBrandProductCount(brandId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCategoryProductCount(cateId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetAttrValueProductCount(attrValueId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByPid(pidList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreProductCount(storeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreClassProductCount(storeCid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreShipTemplateProductCount(storeSTid);
        }
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.CreateProductAttribute(productAttributeInfo);
            if (_productnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateProductAttribute(productAttributeInfo);
            if (_productnosql != null)
                _productnosql.ClearProductAttribute(productAttributeInfo.Pid);
            return result;
        }
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.DeleteProductAttributeByPidAndAttrId(pid, attrId);
            if (_productnosql != null)
        ...
        public static ProductAttributeInfo GetProductAttributeByPidAndAttrId(int pid, int attrId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetProductAttributeByPidAndAttrId(pid, attrId);
            if (reader.Read())
            {
        ...
        public static List<ProductAttributeInfo> GetProductAttributeList(int pid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetProductAttributeList(pid);
            while (reader.Read())
            {
        ...
        public static List<ExtProductAttributeInfo> GetExtProductAttributeList(int pid)
        {
            ...
            if (_productnosql != null)
            {
                ...
                if (extProductAttributeList == null)
                {
                    ...
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetExtProductAttributeList(pid);
                    while (reader.Read())
                    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateProductSKUItem(productSKUItemInfo);
            if (_productnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProductSKUItemList(pid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistSKUGid(skuGid);
        }
        ...
        public static List<ExtProductSKUItemInfo> GetProductSKUListBySKUGid(int skuGid)
        {
            ...
            if (_productnosql != null)
            {
                ...
                if (productSKUList == null)
                {
                    ...
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetProductSKUListBySKUGid(skuGid);
                    while (reader.Read())
                    {
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.CreateProductImage(productImageInfo);
            if (_productnosql != null)
        ...
        public static ProductImageInfo GetProductImageById(int pImgId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetProductImageById(pImgId);
            if (reader.Read())
            {
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.DeleteProductImageById(pImgId);
            if (_productnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.SetProductMainImage(pid, pImgId);
            if (_productnosql != null)
                _productnosql.ClearProductImage(pid);
            return result;
        }
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.ChangeProductImageDisplayOrder(pImgId, displayOrder);
            if (_productnosql != null)
                _productnosql.ClearProductImage(pid);
            return result;
        }
        ...
        public static List<ProductImageInfo> GetProductImageList(int pid)
        {
            ...
            if (_productnosql != null)
            {
                ...
                if (productImageList == null)
                {
                    ...
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetProductImageList(pid);
                    while (reader.Read())
                    {
        ...
        public static ProductStockInfo GetProductStockByPid(int pid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetProductStockByPid(pid);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.CreateProductStock(pid, number, limit);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateProductStock(pid, number, limit);
            if (_productnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateProductStockNumber(pid, number);
            if (_productnosql != null)
                _productnosql.ClearProductStockNumber(pid);
            return result;
        }
        ...
        public static int GetProductStockNumberByPid(int pid)
        {
            ...
            if (_productnosql != null)
            {
                ...
                {
                    productStockNumber = NStore.Core.BMAData.RDBS.GetProductStockNumberByPid(pid);
        ...
        {
            NStore.Core.BMAData.RDBS.IncreaseProductStockNumber(orderProductList);
            if (_productnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.DecreaseProductStockNumber(orderProductList);
            if (_productnosql != null)
        ...
        public static List<ProductStockInfo> GetProductStockList(string pidList)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetProductStockList(pidList);
            while (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateProductKeyword(productKeywordInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateProductKeyword(productKeywordInfo);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.DeleteProductKeyword(keywordIdList);
        }
        ...
        public static List<ProductKeywordInfo> GetProductKeywordList(int pid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetProductKeywordList(pid);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistProductKeyword(pid, keyword);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.UpdateProductKeywordRelevancy(keywordId, relevancy);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetPidByKeywordId(keywordId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByKeywordId(keywordIdList);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.AddRelateProduct(pid, relatePid);
            if (_productnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.DeleteRelateProductByPidAndRelatePid(pid, relatePid);
            if (_productnosql != null)
                _productnosql.ClearRelatePidList(pid);
            return result;
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistRelateProduct(pid, relatePid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetRelateProductList(pid);
        }
        ...
        public static List<PartProductInfo> GetRelateProductList(int pid)
        {
            ...
            {
                partProductList = new List<PartProductInfo>();
                IDataReader reader = NStore.Core.BMAData.RDBS.GetRelateProductList(pid);
                while (reader.Read())
                {
                    PartProductInfo partProductInfo = BuildPartProductFromReader(reader);
                    partProductList.Add(partProductInfo);
        ...
        public static List<TimeProductInfo> GetTimeProductList(int type)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetTimeProductList(type);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetTimeProductList(pageSize, pageNumber, storeId, productName);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetTimeProductCount(storeId, productName);
        }
        ...
        public static TimeProductInfo GetTimeProductByRecordId(int recordId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetTimeProductByRecordId(recordId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.AddTimeProduct(timeProductInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateTimeProduct(timeProductInfo);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistTimeProduct(pid);
        }
