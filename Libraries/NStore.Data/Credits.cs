...
namespace NStore.Data
{
    ...
    public partial class Credits
    {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCreditLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCreditLogListCondition(uid, startTime, endTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCreditLogCount(condition);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.SendCredits(userRid, creditLogInfo);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetTodaySendPayCredits(uid, today);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetTodaySendRankCredits(uid, today);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsSendTodayLoginCredit(uid, today);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsSendCompleteUserInfoCredit(uid);
        }
        ...
        public static List<CreditLogInfo> GetPayCreditLogList(int uid, int type, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetPayCreditLogList(uid, type, pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetPayCreditLogCount(uid, type);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUserOrderSendCredits(oid);
        }
    }
}
