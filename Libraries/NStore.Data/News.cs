...
namespace NStore.Data
{
    ...
    public partial class News
    {
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteNewsTypeById(newsTypeId);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateNewsType(newsTypeInfo);
        }
        ...
        public static List<NewsTypeInfo> GetNewsTypeList()
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetNewsTypeList();
            while (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateNews(newsInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteNewsById(newsIdList);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateNews(newsInfo);
        }
        ...
        public static NewsInfo GetNewsById(int newsId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetNewsById(newsId);
            if (reader.Read())
            {
        ...
        {
            NewsInfo newsInfo = null;
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetNewsById(newsId);
            if (reader.Read())
            {
                newsInfo = BuildNewsFromReader(reader);
            }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetNewsList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetNewsListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetNewsCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetNewsIdByTitle(title);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetHomeNewsList(newsTypeId, count);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetNewsList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetNewsCount(condition);
        }
    }
}
