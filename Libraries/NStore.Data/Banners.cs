...
namespace NStore.Data
{
    ...
    public partial class Banners
    {
        ...
        {
            DataTable dt = NStore.Core.BMAData.RDBS.GetHomeBannerList(type, nowTime);
        ...
        public static List<BannerInfo> AdminGetBannerList(int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetBannerList(pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBannerCount();
        }
        ...
        public static BannerInfo AdminGetBannerById(int id)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetBannerById(id);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateBanner(bannerInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateBanner(bannerInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteBannerById(idList);
        }
    }
}
