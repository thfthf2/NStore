...
namespace NStore.Data
{
    ...
    public partial class UserRanks
    {
        ...
        public static List<UserRankInfo> GetUserRankList()
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetUserRankList();
            while(reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateUserRank(userRankInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteUserRankById(userRid);
        }
