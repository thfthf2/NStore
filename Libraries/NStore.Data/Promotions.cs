...
namespace NStore.Data
{
    ...
    public partial class Promotions
    {
        ...
        public static SinglePromotionInfo AdminGetSinglePromotionById(int pmId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetSinglePromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateSinglePromotion(singlePromotionInfo);
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateSinglePromotion(singlePromotionInfo);
            if (_promotionnosql != null)
                _promotionnosql.DeleteProductSinglePromotion(singlePromotionInfo.Pid);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteSinglePromotionById(pmIdList);
            if (_promotionnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetSinglePromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetSinglePromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetSinglePromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetSinglePromotionCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminIsExistSinglePromotion(pid, startTime, endTime);
        }
        ...
        public static SinglePromotionInfo GetSinglePromotionByPidAndTime(int pid, DateTime nowTime)
        {
            ...
            if (_promotionnosql != null)
            {
                ...
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetSinglePromotionByPidAndTime(pid, nowTime);
                    if (reader.Read())
                    {
                        singlePromotionInfo = BuildSinglePromotionFromReader(reader);
                    }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetSinglePromotionProductBuyCount(uid, pmId);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateSinglePromotionStock(singlePromotionList);
            if (_promotionnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListBySinglePmId(pmIdList);
        }
        ...
        public static List<string> GetSinglePromotionPidList(string pmIdList)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetSinglePromotionPidList(pmIdList);
            while (reader.Read())
            {
        ...
        public static BuySendPromotionInfo AdminGetBuySendPromotionById(int pmId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetBuySendPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateBuySendPromotion(buySendPromotionInfo);
            if (_promotionnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateBuySendPromotion(buySendPromotionInfo);
            if (_promotionnosql != null)
                _promotionnosql.ClearAllBuySendPromotion(buySendPromotionInfo.StoreId);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteBuySendPromotionById(pmIdList);
            if (_promotionnosql != null)
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBuySendPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBuySendPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBuySendPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBuySendPromotionCount(condition);
        }
            ...
            if (_promotionnosql != null)
            {
                ...
                if (allBuySendPromotion.Count > 0)//当买送促销活动存在时
                {
                    ...
                    if (productBuySendPromotionIdList == null)
                    {
                        ...
                        IDataReader reader = NStore.Core.BMAData.RDBS.GetBuySendPromotionList(storeId, pid, nowTime);
                        while (reader.Read())
                        {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByBuySendPmId(pmIdList);
        }
        ...
        public static List<BuySendPromotionInfo> GetAllBuySendPromotion(int storeId, DateTime nowTime)
        {
            ...
            if (_promotionnosql != null)
            {
                ...
                if (allBuySendPromotion == null)
                {
                    ...
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetAllBuySendPromotion(storeId, nowTime);
                    while (reader.Read())
                    {
                        BuySendPromotionInfo buySendPromotionInfo = BuildBuySendPromotionFromReader(reader);
        ...
        {
            NStore.Core.BMAData.RDBS.AddBuySendProduct(pmId, pid);
            if (_promotionnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.DeleteBuySendProductByRecordId(recordIdList);
            if (_promotionnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistBuySendProduct(pmId, pid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBuySendProductList(pageSize, pageNumber, pmId, pid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBuySendProductCount(pmId, pid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByBuySendProductRecordId(recordIdList);
        }
        ...
        public static List<string> GetBuySendPidList(string recordIdList)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetBuySendPidList(recordIdList);
            while (reader.Read())
            {
        ...
        public static GiftPromotionInfo AdminGetGiftPromotionById(int pmId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetGiftPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateGiftPromotion(giftPromotionInfo);
            if (_promotionnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateGiftPromotion(giftPromotionInfo);
            if (_promotionnosql != null)
                _promotionnosql.DeleteProductGiftPromotion(giftPromotionInfo.Pid);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteGiftPromotionById(pmIdList);
            if (_promotionnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetGiftPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetGiftPromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetGiftPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetGiftPromotionCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminIsExistGiftPromotion(pid, startTime, endTime);
        }
        ...
        public static GiftPromotionInfo GetGiftPromotionByPidAndTime(int pid, DateTime nowTime)
        {
            ...
            if (_promotionnosql != null)
            {
                ...
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetGiftPromotionByPidAndTime(pid, nowTime);
                    if (reader.Read())
                    {
                        giftPromotionInfo = BuildGiftPromotionFromReader(reader);
                    }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByGiftPmId(pmIdList);
        }
        ...
        public static List<string> GetGiftPromotionPidList(string pmIdList)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetGiftPromotionPidList(pmIdList);
            while (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.AddGift(pmId, giftId, number, pid);
            if (_promotionnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.DeleteGiftByPmIdAndGiftId(pmId, giftId);
            if (_promotionnosql != null)
                _promotionnosql.DeleteExtGiftList(pmId);
            return result;
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistGift(pmId, giftId);
        }
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateGiftNumber(pmId, giftId, number);
            if (_promotionnosql != null)
                _promotionnosql.DeleteExtGiftList(pmId);
            return result;
        }
        ...
        public static List<ExtGiftInfo> AdminGetExtGiftList(int pmId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetExtGiftList(pmId);
            while (reader.Read())
            {
        ...
        public static List<ExtGiftInfo> GetExtGiftList(int pmId)
        {
            ...
            {
                extGiftList = new List<ExtGiftInfo>();
                IDataReader reader = NStore.Core.BMAData.RDBS.GetExtGiftList(pmId);
                while (reader.Read())
                {
                    ExtGiftInfo extGiftInfo = BuildExtGiftFromReader(reader);
                    extGiftList.Add(extGiftInfo);
        ...
        public static SuitPromotionInfo AdminGetSuitPromotionById(int pmId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetSuitPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.CreateSuitPromotion(suitPromotionInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateSuitPromotion(suitPromotionInfo);
            if (_promotionnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteSuitPromotionById(pmIdList);
            if (_promotionnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetSuitPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetSuitPromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetSuitPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetSuitPromotionCount(condition);
        }
        ...
        public static SuitPromotionInfo GetSuitPromotionByPmIdAndTime(int pmId, DateTime nowTime)
        {
            ...
            if (_promotionnosql != null)
            {
                ...
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetSuitPromotionByPmIdAndTime(pmId, nowTime);
                    if (reader.Read())
                    {
                        suitPromotionInfo = BuildSuitPromotionFromReader(reader);
                    }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsJoinSuitPromotion(uid, pmId);
        }
        ...
        public static List<SuitPromotionInfo> GetSuitPromotionList(int pid, DateTime nowTime)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetSuitPromotionList(pid, nowTime);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListBySuitPmId(pmIdList);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.AddSuitProduct(pmId, pid, discount, number);
            if (_promotionnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.DeleteSuitProductByPmIdAndPid(pmId, pid);
            if (_promotionnosql != null)
                _promotionnosql.DeleteSuitProductList(pmId);
            return result;
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistSuitProduct(pmId, pid);
        }
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateSuitProductNumber(pmId, pid, number);
            if (_promotionnosql != null)
                _promotionnosql.DeleteSuitProductList(pmId);
            return result;
        }
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateSuitProductDiscount(pmId, pid, discount);
            if (_promotionnosql != null)
                _promotionnosql.DeleteSuitProductList(pmId);
            return result;
        }
        ...
        public static List<ExtSuitProductInfo> AdminGetExtSuitProductList(int pmId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetExtSuitProductList(pmId);
            while (reader.Read())
            {
        ...
        public static List<ExtSuitProductInfo> GetExtSuitProductList(int pmId)
        {
            ...
            {
                extSuitProductList = new List<ExtSuitProductInfo>();
                IDataReader reader = NStore.Core.BMAData.RDBS.GetExtSuitProductList(pmId);
                while (reader.Read())
                {
                    ExtSuitProductInfo extSuitProductInfo = BuildExtSuitProductFromReader(reader);
                    extSuitProductList.Add(extSuitProductInfo);
        ...
        {
            List<ExtSuitProductInfo> extSuitProductList = new List<ExtSuitProductInfo>();
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetAllExtSuitProductList(pmIdList);
            while (reader.Read())
            {
                ExtSuitProductInfo extSuitProductInfo = BuildExtSuitProductFromReader(reader);
                extSuitProductList.Add(extSuitProductInfo);
        ...
        public static List<ExtSuitProductInfo> GetAllExtSuitProductList(string pmIdList)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetAllExtSuitProductList(pmIdList);
            while (reader.Read())
            {
                ExtSuitProductInfo extSuitProductInfo = BuildExtSuitProductFromReader(reader);
                extSuitProductList.Add(extSuitProductInfo);
        ...
        public static FullSendPromotionInfo AdminGetFullSendPromotionById(int pmId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetFullSendPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateFullSendPromotion(fullSendPromotionInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateFullSendPromotion(fullSendPromotionInfo);
            if (_promotionnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteFullSendPromotionById(pmIdList);
            if (_promotionnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullSendPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullSendPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullSendPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullSendPromotionCount(condition);
        }
        ...
        public static FullSendPromotionInfo GetFullSendPromotionByStoreIdAndPidAndTime(int storeId, int pid, DateTime nowTime)
        {
            ...
            if (_promotionnosql != null)
            {
                ...
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetFullSendPromotionByStoreIdAndPidAndTime(storeId, pid, nowTime);
                    if (reader.Read())
                    {
                        fullSendPromotionInfo = BuildFullSendPromotionFromReader(reader);
                    }
        ...
        public static FullSendPromotionInfo GetFullSendPromotionByPmIdAndTime(int pmId, DateTime nowTime)
        {
            ...
            if (_promotionnosql != null)
            {
                ...
                if (fullSendPromotionInfo == null)
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetFullSendPromotionByPmIdAndTime(pmId, nowTime);
                    if (reader.Read())
                    {
                        fullSendPromotionInfo = BuildFullSendPromotionFromReader(reader);
                    }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByFullSendPmId(pmIdList);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.AddFullSendProduct(pmId, pid, type);
            if (_promotionnosql != null)
            {
                if (type == 0)
        ...
        public static bool DeleteFullSendProductByRecordId(string recordIdList)
        {
            ...
            return NStore.Core.BMAData.RDBS.DeleteFullSendProductByRecordId(recordIdList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistFullSendProduct(pmId, pid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullSendProductList(pageSize, pageNumber, pmId, type);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullSendProductCount(pmId, type);
        }
        ...
        public static bool IsExistFullSendProduct(int pmId, int pid, int type)
        {
            ...
            return NStore.Core.BMAData.RDBS.IsExistFullSendProduct(pmId, pid, type);
        }
        ...
        public static List<StoreProductInfo> GetFullSendMainProductList(int pageSize, int pageNumber, int pmId, int startPrice, int endPrice, int sortColumn, int sortDirection)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetFullSendMainProductList(pageSize, pageNumber, pmId, startPrice, endPrice, sortColumn, sortDirection);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetFullSendMainProductCount(pmId, startPrice, endPrice);
        }
        ...
        public static List<PartProductInfo> GetFullSendPresentList(int pmId)
        {
            ...
            else
            {
                ...
                IDataReader reader = NStore.Core.BMAData.RDBS.GetFullSendPresentList(pmId);
                while (reader.Read())
                {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByFullSendProductRecordId(recordIdList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetFullSendProductList(recordIdList);
        }
        ...
        public static FullCutPromotionInfo AdminGetFullCutPromotionById(int pmId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetFullCutPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateFullCutPromotion(fullCutPromotionInfo);
            if (_promotionnosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateFullCutPromotion(fullCutPromotionInfo);
            if (_promotionnosql != null)
                _promotionnosql.ClearAllFullCutPromotion(fullCutPromotionInfo.StoreId);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteFullCutPromotionById(pmIdList);
            if (_promotionnosql != null)
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullCutPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullCutPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullCutPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullCutPromotionCount(condition);
        }
        ...
        public static FullCutPromotionInfo GetFullCutPromotionByStoreIdAndPidAndTime(int storeId, int pid, DateTime nowTime)
        {
            ...
            if (_promotionnosql != null)
            {
                ...
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetFullCutPromotionByStoreIdAndPidAndTime(storeId, pid, nowTime);
                    if (reader.Read())
                    {
                        fullCutPromotionInfo = BuildFullCutPromotionFromReader(reader);
                    }
        ...
        public static FullCutPromotionInfo GetFullCutPromotionByStoreIdAndPmIdAndTime(int storeId, int pmId, DateTime nowTime)
        {
            ...
            {
                IDataReader reader = NStore.Core.BMAData.RDBS.GetFullCutPromotionByPmIdAndTime(pmId, nowTime);
                if (reader.Read())
                {
                    fullCutPromotionInfo = BuildFullCutPromotionFromReader(reader);
                }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByFullCutPmId(pmIdList);
        }
        ...
        public static List<FullCutPromotionInfo> GetAllFullCutPromotion(int storeId, DateTime nowTime)
        {
            ...
            if (_promotionnosql != null)
            {
                ...
                if (allFullCutPromotion == null)
                {
                    ...
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetAllFullCutPromotion(storeId, nowTime);
                    while (reader.Read())
                    {
        ...
        {
            NStore.Core.BMAData.RDBS.AddFullCutProduct(pmId, pid);
            if (_promotionnosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.DeleteFullCutProductByRecordId(recordIdList);
            if (_promotionnosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistFullCutProduct(pmId, pid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullCutProductList(pageSize, pageNumber, pmId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetFullCutProductCount(pmId);
        }
        ...
        {
            List<StoreProductInfo> storeProductList = new List<StoreProductInfo>();
            IDataReader reader = NStore.Core.BMAData.RDBS.GetFullCutProductList(pageSize, pageNumber, fullCutPromotionInfo, startPrice, endPrice, sortColumn, sortDirection);
            while (reader.Read())
            {
                StoreProductInfo storeProductInfo = Products.BuildStoreProductFromReader(reader);
                storeProductList.Add(storeProductInfo);
        ...
        {
            return NStore.Core.BMAData.RDBS.GetFullCutProductCount(fullCutPromotionInfo, startPrice, endPrice);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByFullCutProductRecordId(recordIdList);
        }
        ...
        public static List<string> GetFullCutPidList(string recordIdList)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetFullCutPidList(recordIdList);
            while (reader.Read())
            {
