...
namespace NStore.Data
{
    ...
    public partial class OrderActions
    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateOrderAction(orderActionInfo);
            if (_ordernosql != null)
        ...
        public static List<OrderActionInfo> GetOrderActionList(int oid)
        {
            ...
            if (_ordernosql != null)
            {
                ...
                if (orderActionList == null)
                {
                    ...
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetOrderActionList(oid);
                    while (reader.Read())
                    {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOrderIdList(startTime, endTime, orderActionType);
        }
    }
}
