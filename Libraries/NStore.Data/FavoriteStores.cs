...
namespace NStore.Data
{
    ...
    public partial class FavoriteStores
    {
        ...
        {
            return NStore.Core.BMAData.RDBS.AddStoreToFavorite(uid, storeId, addTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.DeleteFavoriteStoreByUidAndStoreId(uid, storeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistFavoriteStore(uid, storeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetFavoriteStoreList(pageSize, pageNumber, uid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetFavoriteStoreCount(uid);
        }
    }
}
