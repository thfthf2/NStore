...
namespace NStore.Data
{
    ...
    public partial class PVStats
    {
        ...
        {
            NStore.Core.BMAData.RDBS.UpdatePVStat(updatePVStatState);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProvinceRegionStat();
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetCityRegionStat(provinceId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetCountyRegionStat(cityId);
        }
        ...
        public static List<PVStatInfo> GetPVStatList(string condition)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetPVStatList(condition);
            while (reader.Read())
            {
        ...
        public static PVStatInfo GetPVStatByCategoryAndValue(string category, string value)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetPVStatByCategoryAndValue(category, value);
            if (reader.Read())
            {
