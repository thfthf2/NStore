...
namespace NStore.Data
{
    ...
    public partial class OrderRefunds
    {
        ...
        {
            NStore.Core.BMAData.RDBS.ApplyRefund(orderRefundInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.RefundOrder(refundId, refundSN, refundSystemName, refundFriendName, refundTime);
        }
        ...
        public static List<OrderRefundInfo> GetOrderRefundList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetOrderRefundList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOrderRefundListCondition(storeId, osn);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOrderRefundCount(condition);
        }
    }
}
