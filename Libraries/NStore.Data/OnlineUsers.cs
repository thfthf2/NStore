...
namespace NStore.Data
{
    ...
    public partial class OnlineUsers
    {
        ...
        {
            return NStore.Core.BMAData.RDBS.CreateOnlineUser(onlineUserInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateOnlineUserIP(olId, ip);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateOnlineUserUid(olId, uid);
        }
        ...
        public static OnlineUserInfo GetOnlineUserBySid(string sid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetOnlineUserBySid(sid);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOnlineUserCount(userType);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteOnlineUserBySid(sid);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteExpiredOnlineUser(onlineUserExpire);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.ResetOnlineUserTable();
        }
        ...
        public static List<OnlineUserInfo> GetOnlineUserList(int pageSize, int pageNumber, int locationType, int locationId, string sort)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetOnlineUserList(pageSize, pageNumber, locationType, locationId, sort);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOnlineUserListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOnlineUserCount(locationType, locationId);
        }
    }
}
