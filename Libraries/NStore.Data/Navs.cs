...
namespace NStore.Data
{
    ...
    public partial class Navs
    {
        ...
        public static List<NavInfo> GetNavList()
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetNavList();
            while (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateNav(navInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteNavById(id);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateNav(navInfo);
        }
    }
}
