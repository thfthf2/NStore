...
namespace NStore.Data
{
    ...
    public partial class SearchHistories
    {
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateSearchHistory(uid, word, updateTime);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.ClearExpiredSearchHistory();
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetSearchWordStatList(pageSize, pageNumber, word, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetSearchWordStatListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetSearchWordStatCount(word);
        }
    }
}
