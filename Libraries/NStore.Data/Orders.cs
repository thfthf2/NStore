    ...
    public partial class Orders
    {
        ...
        public static OrderInfo GetOrderByOid(int oid)
        {
            ...
            if (_ordernosql != null)
            {
                ...
                if (orderInfo == null)
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetOrderByOid(oid);
                    if (reader.Read())
                    {
        ...
        {
            OrderInfo orderInfo = null;
            IDataReader reader = NStore.Core.BMAData.RDBS.GetOrderByOSN(osn);
            if (reader.Read())
            {
                orderInfo = BuildOrderFromReader(reader);
            }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOrderCountByCondition(storeId, orderState, startTime, endTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOrderList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOrderListCondition(storeId, osn, uid, consignee, orderState);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOrderListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetOrderCount(condition);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateOrderDiscount(oid, discount, surplusMoney);
            if (_ordernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateOrderShipFee(oid, shipFee, orderAmount, surplusMoney);
            if (_ordernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateOrderState(oid, orderState);
            if (_ordernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.SendOrderProduct(oid, orderState, shipSN, shipCoId, shipCoName, shipTime);
            if (_ordernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.PayOrder(oid, orderState, paySN, payTime);
            if (_ordernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateOrderIsReview(oid, isReview);
            if (_ordernosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUserOrderList(uid, pageSize, pageNumber, startAddTime, endAddTime, orderState);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUserOrderCount(uid, startAddTime, endAddTime, orderState);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetSaleProductList(pageSize, pageNumber, startTime, endTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetSaleProductCount(startTime, endTime);
        }
