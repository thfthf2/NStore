...
namespace NStore.Data
{
    ...
    public partial class MallAdminLogs
    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateMallAdminLog(mallAdminLogInfo);
        }
        ...
        public static List<MallAdminLogInfo> GetMallAdminLogList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetMallAdminLogList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetMallAdminLogListCondition(uid, operation, startTime, endTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetMallAdminLogCount(condition);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteMallAdminLogById(logIdList);
        }
