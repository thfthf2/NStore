...
namespace NStore.Data
{
    ...
    public partial class Regions
    {
        ...
        {
            DataTable dt = NStore.Core.BMAData.RDBS.GetAllRegion();
        ...
        public static List<RegionInfo> GetRegionList(int parentId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetRegionList(parentId);
            while (reader.Read())
            {
        ...
        public static RegionInfo GetRegionById(int regionId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetRegionById(regionId);
            if (reader.Read())
            {
        ...
        {
            RegionInfo regionInfo = null;
            IDataReader reader = NStore.Core.BMAData.RDBS.GetRegionByNameAndLayer(name, layer);
            if (reader.Read())
            {
                regionInfo = BuildRegionFromReader(reader);
            }
