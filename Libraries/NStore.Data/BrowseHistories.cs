...
namespace NStore.Data
{
    ...
    public partial class BrowseHistories
    {
        ...
        public static List<PartProductInfo> GetUserBrowseProductList(int pageSize, int pageNumber, int uid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetUserBrowseProductList(pageSize, pageNumber, uid);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUserBrowseProductCount(uid);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateBrowseHistory(uid, pid, updateTime);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.ClearExpiredBrowseHistory();
        }
    }
}
