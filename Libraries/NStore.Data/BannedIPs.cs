...
namespace NStore.Data
{
    ...
    public partial class BannedIPs
    {
        ...
        public static HashSet<string> GetBannedIPList()
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetBannedIPList();
            while (reader.Read())
            {
        ...
        public static BannedIPInfo GetBannedIPById(int id)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetBannedIPById(id);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetBannedIPIdByIP(ip);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.AddBannedIP(bannedIPInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateBannedIP(bannedIPInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteBannedIPById(idList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBannedIPList(pageSize, pageNumber, ip, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBannedIPListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBannedIPCount(ip);
        }
    }
}
