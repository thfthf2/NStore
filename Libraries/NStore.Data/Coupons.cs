...
namespace NStore.Data
{
    ...
    public partial class Coupons
    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateCouponType(couponTypeInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteCouponTypeById(couponTypeIdList);
        }
        ...
        public static CouponTypeInfo GetCouponTypeById(int couponTypeId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetCouponTypeById(couponTypeId);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCouponTypeListCondition(storeId, type, couponTypeName);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCouponTypeList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCouponTypeCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.ChangeCouponTypeState(couponTypeId, state);
        }
        ...
        public static List<CouponTypeInfo> GetSendingPromotionCouponTypeList(int storeId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetSendingPromotionCouponTypeList(storeId);
            while (reader.Read())
            {
        ...
        {
            List<CouponTypeInfo> couponTypeList = new List<CouponTypeInfo>();
            IDataReader reader = NStore.Core.BMAData.RDBS.GetSendingCouponTypeList(storeId, nowTime);
            while (reader.Read())
            {
                CouponTypeInfo couponTypeInfo = BuildCouponTypeFromReader(reader);
                couponTypeList.Add(couponTypeInfo);
        ...
        {
            List<CouponTypeInfo> couponTypeList = new List<CouponTypeInfo>();
            IDataReader reader = NStore.Core.BMAData.RDBS.GetUsingCouponTypeList(storeId, nowTime);
            while (reader.Read())
            {
                CouponTypeInfo couponTypeInfo = BuildCouponTypeFromReader(reader);
                couponTypeList.Add(couponTypeInfo);
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByCouponTypeId(couponTypeIdList);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.CreateCoupon(couponInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteCouponById(idList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCouponListCondition(sn, uid, couponTypeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCouponList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCouponCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistCouponSN(couponSN);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetSendCouponCount(couponTypeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetSendUserCouponCount(uid, couponTypeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetTodaySendUserCouponCount(uid, couponTypeId, today);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetCouponList(uid, type);
        }
        ...
        public static CouponInfo GetCouponByCouponId(int couponId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetCouponByCouponId(couponId);
            if (reader.Read())
            {
        ...
        {
            CouponInfo couponInfo = null;
            IDataReader reader = NStore.Core.BMAData.RDBS.GetCouponByCouponSN(couponSN);
            if (reader.Read())
            {
                couponInfo = BuildCouponFromReader(reader);
            }
        ...
        {
            NStore.Core.BMAData.RDBS.UseCoupon(couponId, oid, time, ip);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.ActivateAndUseCoupon(couponId, uid, oid, time, ip);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.ActivateCoupon(couponId, uid, time, ip);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.ReturnUserOrderUseCoupons(oid);
        }
        ...
        public static List<CouponInfo> GetUserOrderSendCouponList(int oid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetUserOrderSendCouponList(oid);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByCouponId(couponIdList);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.AddCouponProduct(couponTypeId, pid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.DeleteCouponProductByRecordId(recordIdList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistCouponProduct(couponTypeId, pid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCouponProductList(pageSize, pageNumber, couponTypeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetCouponProductCount(couponTypeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsSameCouponType(couponTypeId, pidList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByCouponProductRecordId(recordIdList);
        }
    }
}
