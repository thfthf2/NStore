...
namespace NStore.Data
{
    ...
    public partial class LoginFailLogs
    {
        ...
        public static LoginFailLogInfo GetLoginFailLogByIP(long loginIP)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetLoginFailLogByIP(loginIP);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.AddLoginFailTimes(loginIP, loginTime);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteLoginFailLogByIP(loginIP);
        }
    }
}
