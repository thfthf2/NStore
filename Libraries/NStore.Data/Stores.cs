...
namespace NStore.Data
{
    ...
    public partial class Stores
    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateStoreReview(storeReviewInfo);
        }
        ...
        public static StoreReviewInfo GetStoreReviewByOid(int oid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreReviewByOid(oid);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.SumStoreReview(storeId, startTime, endTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.CreateStore(storeInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateStore(storeInfo);
            if (_storenosql != null)
        ...
        public static StoreInfo GetStoreById(int storeId)
        {
            ...
            if (_storenosql != null)
            {
                ...
                if (storeInfo == null)
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreById(storeId);
                    if (reader.Read())
                    {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreSelectList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreListCondition(storeName, storeRid, storeIid, state);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdByName(storeName);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreIdByName(storeName);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateStoreState(storeId, state, stateEndTime);
            if (_storenosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateStorePoint(storeId, dePoint, sePoint, shPoint);
            if (_storenosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteStoreById(storeId);
            if (_storenosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreCountByStoreIid(storeIid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreCountByStoreRid(storeRid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdList();
        }
        ...
        {
            NStore.Core.BMAData.RDBS.CreateStoreKeeper(storeKeeperInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateStoreKeeper(storeKeeperInfo);
            if (_storenosql != null)
        ...
        public static StoreKeeperInfo GetStoreKeeperById(int storeId)
        {
            ...
            if (_storenosql != null)
            {
                ...
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreKeeperById(storeId);
                    if (reader.Read())
                    {
        ...
        public static List<StoreClassInfo> GetStoreClassList(int storeId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreClassList(storeId);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.CreateStoreClass(storeClassInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateStoreClass(storeClassInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteStoreClassById(storeCid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.CreateStoreShipTemplate(storeShipTemplateInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateStoreShipTemplate(storeShipTemplateInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteStoreShipTemplateById(storeSTId);
        }
        ...
        public static StoreShipTemplateInfo GetStoreShipTemplateById(int storeSTId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreShipTemplateById(storeSTId);
            if (reader.Read())
            {
        ...
        public static List<StoreShipTemplateInfo> GetStoreShipTemplateList(int storeId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreShipTemplateList(storeId);
            while (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateStoreShipFee(storeShipFeeInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateStoreShipFee(storeShipFeeInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteStoreShipFeeById(recordId);
        }
        ...
        public static StoreShipFeeInfo GetStoreShipFeeById(int recordId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreShipFeeById(recordId);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetStoreShipFeeList(storeSTid);
        }
        ...
        {
            StoreShipFeeInfo storeShipFeeInfo = null;
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreShipFeeByStoreSTidAndRegion(storeSTid, provinceId, cityId);
            if (reader.Read())
            {
                storeShipFeeInfo = BuildStoreShipFeeFromReader(reader);
            }
