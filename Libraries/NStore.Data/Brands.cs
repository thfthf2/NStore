...
namespace NStore.Data
{
    ...
    public partial class Brands
    {
        ...
        public static BrandInfo GetBrandById(int brandId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetBrandById(brandId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateBrand(brandInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteBrandById(brandId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBrandListCondition(brandName);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBrandListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBrandList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBrandSelectList(pageSize, pageNumber, condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetBrandCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetBrandIdByName(brandName);
        }
        ...
        public static List<CategoryInfo> GetBrandCategoryList(int brandId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetBrandCategoryList(brandId);
            while (reader.Read())
            {
        ...
        public static List<BrandInfo> GetBrandList(int pageSize, int pageNumber, string brandName)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetBrandList(pageSize, pageNumber, brandName);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetBrandCount(brandName);
        }
    }
}
