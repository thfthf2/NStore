...
namespace NStore.Data
{
    ...
    public partial class ProductConsults
    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateProductConsultType(productConsultTypeInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteProductConsultTypeById(consultTypeId);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.ConsultProduct(pid, consultTypeId, consultUid, storeId, consultTime, consultMessage, consultNickName, pName, pShowImg, consultIP);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.ReplyProductConsult(consultId, replyUid, replyTime, replyMessage, replyNickName, replyIP);
        }
        ...
        public static ProductConsultInfo GetProductConsultById(int consultId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetProductConsultById(consultId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteProductConsultById(consultIdList);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductConsultList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductConsultListCondition(consultTypeId, storeId, pid, uid, consultMessage, consultStartTime, consultEndTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductConsultListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductConsultCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.UpdateProductConsultState(consultId, state);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProductConsultCount(pid, consultTypeId, consultMessage);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUserProductConsultCount(uid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreIdListByConsultId(consultIdList);
        }
    }
}
