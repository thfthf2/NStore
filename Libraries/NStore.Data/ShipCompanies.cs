...
namespace NStore.Data
{
    ...
    public partial class ShipCompanies
    {
        ...
        public static List<ShipCompanyInfo> GetShipCompanyList(int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetShipCompanyList(pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetShipCompanyCount();
        }
        ...
        public static ShipCompanyInfo GetShipCompanyById(int shipCoId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetShipCompanyById(shipCoId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateShipCompany(shipCompanyInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteShipCompanyById(shipCoId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetShipCoIdByName(shipCoName);
        }
    }
}
