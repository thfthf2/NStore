...
namespace NStore.Data
{
    ...
    public partial class FriendLinks
    {
        ...
        {
            DataTable dt = NStore.Core.BMAData.RDBS.GetFriendLinkList();
        ...
        {
            NStore.Core.BMAData.RDBS.CreateFriendLink(friendLinkInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteFriendLinkById(idList);
        }
