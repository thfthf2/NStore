...
namespace NStore.Data
{
    ...
    public partial class ShipAddresses
    {
        ...
        {
            int saId = NStore.Core.BMAData.RDBS.CreateShipAddress(shipAddressInfo);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateShipAddress(shipAddressInfo);
            if (_usernosql != null)
                _usernosql.DeleteFullShipAddressList(shipAddressInfo.Uid);
        }
        ...
        public static int GetShipAddressCount(int uid)
        {
            ...
            return NStore.Core.BMAData.RDBS.GetShipAddressCount(uid);
        }
        ...
        public static FullShipAddressInfo GetDefaultFullShipAddress(int uid)
        {
            ...
            {
                IDataReader reader = NStore.Core.BMAData.RDBS.GetDefaultFullShipAddress(uid);
                if (reader.Read())
                {
        ...
        public static FullShipAddressInfo GetFullShipAddressBySAId(int uid, int saId)
        {
            ...
            {
                IDataReader reader = NStore.Core.BMAData.RDBS.GetFullShipAddressBySAId(saId);
                if (reader.Read())
                {
                    fullShipAddressInfo = BuildFullShipAddressFromReader(reader);
                }
        ...
        public static ShipAddressInfo GetShipAddressBySAId(int uid, int saId)
        {
            ...
            {
                IDataReader reader = NStore.Core.BMAData.RDBS.GetShipAddressBySAId(saId);
                if (reader.Read())
                {
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.DeleteShipAddress(saId, uid);
            if (_usernosql != null)
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateShipAddressIsDefault(saId, uid, isDefault);
            if (_usernosql != null)
