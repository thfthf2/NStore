...
namespace NStore.Data
{
    ...
    public partial class Helps
    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateHelp(helpInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteHelpById(id);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateHelp(helpInfo);
        }
        ...
        public static List<HelpInfo> GetHelpList()
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetHelpList();
        ...
        {
            return NStore.Core.BMAData.RDBS.UpdateHelpDisplayOrder(id, displayOrder);
        }
    }
}
