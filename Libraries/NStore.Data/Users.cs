...
namespace NStore.Data
{
    ...
    public partial class Users
    {
        ...
        public static UserInfo GetUserById(int uid)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetUserById(uid);
            if (reader.Read())
            {
        ...
        public static PartUserInfo GetPartUserById(int uid)
        {
            ...
            if (_usernosql != null)
            {
                ...
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetPartUserById(uid);
                    if (reader.Read())
                    {
        ...
        public static UserDetailInfo GetUserDetailById(int uid)
        {
            ...
            if (_usernosql != null)
            {
                ...
                {
                    IDataReader reader = NStore.Core.BMAData.RDBS.GetUserDetailById(uid);
                    if (reader.Read())
                    {
        ...
        public static PartUserInfo GetPartUserByName(string userName)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetPartUserByName(userName);
            if (reader.Read())
            {
                partUserInfo = BuildPartUserFromReader(reader);
            }
        ...
        public static PartUserInfo GetPartUserByEmail(string email)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetPartUserByEmail(email);
            if (reader.Read())
            {
                partUserInfo = BuildPartUserFromReader(reader);
            }
        ...
        public static PartUserInfo GetPartUserByMobile(string mobile)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetPartUserByMobile(mobile);
            if (reader.Read())
            {
                partUserInfo = BuildPartUserFromReader(reader);
            }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUidByUserName(userName);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUidByEmail(email);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUidByMobile(mobile);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.CreateUser(userInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateUser(userInfo);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdatePartUser(partUserInfo);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateUserDetail(userDetailInfo);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateUserLastVisit(uid, visitTime, ip, regionId);
            if (_usernosql != null)
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetUserList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetUserListCondition(userName, email, mobile, userRid, mallAGid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetUserListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetUserCount(condition);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteUserById(uidList);
            if (_usernosql != null)
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUserCountByUserRid(userRid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUserCountByMallAGid(mallAGid);
        }
        ...
        {
            bool result = NStore.Core.BMAData.RDBS.UpdateUser(uid, userName, nickName, avatar, gender, realName, bday, idCard, regionId, address, bio);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateUserEmailByUid(uid, email);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateUserMobileByUid(uid, mobile);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateUserPasswordByUid(uid, password);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateUserLiftBanTimeByUid(uid, liftBanTime);
            if (_usernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateUserOnlineTime(uid, onlineTime, updateTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetRegisterTimeByRegisterIP(registerIP);
        }
        ...
        public static DateTime GetUserLastVisitTimeByUid(int uid)
        {
            ...
            {
                return NStore.Core.BMAData.RDBS.GetUserLastVisitTimeByUid(uid);
            }
        }
        ...
        public static void SetStoreAdminer(int uid, int storeId)
        {
            ...
            NStore.Core.BMAData.RDBS.SetStoreAdminer(uid, storeId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreAdminerIdByStoreId(storeId);
        }
    }
}
