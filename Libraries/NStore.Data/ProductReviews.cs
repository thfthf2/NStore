...
namespace NStore.Data
{
    ...
    public partial class ProductReviews
    {
        ...
        {
            ProductReviewInfo productReviewInfo = null;
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetProductReviewById(reviewId);
            if (reader.Read())
            {
                productReviewInfo = BuildProductReviewFromReader(reader);
            }
        ...
        {
            NStore.Core.BMAData.RDBS.ReviewProduct(productReviewInfo);
            if (_ordernosql != null)
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteProductReviewById(reviewId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductReviewList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductReviewListCondition(storeId, pid, message, startTime, endTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductReviewListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductReviewCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetProductReviewReplyList(reviewId);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.VoteProductReview(reviewId, uid, voteTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsVoteProductReview(reviewId, uid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.ChangeProductReviewState(reviewId, state);
        }
        ...
        public static List<ProductReviewInfo> GetUserProductReviewList(int uid, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetUserProductReviewList(uid, pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetUserProductReviewCount(uid);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProductReviewList(pid, type, pageSize, pageNumber);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProductReviewCount(pid, type);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProductReviewWithReplyById(reviewId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetProductReviewList(startTime, endTime);
        }
    }
}
