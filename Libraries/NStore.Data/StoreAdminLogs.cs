...
namespace NStore.Data
{
    ...
    public partial class StoreAdminLogs
    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateStoreAdminLog(storeAdminLogInfo);
        }
        ...
        public static List<StoreAdminLogInfo> GetStoreAdminLogList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetStoreAdminLogList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreAdminLogListCondition(storeId, operation, startTime, endTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.GetStoreAdminLogCount(condition);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteStoreAdminLogById(logIdList);
        }
    }
}
