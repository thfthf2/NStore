...
namespace NStore.Data
{
    ...
    public partial class Adverts
    {
        ...
        public static List<AdvertPositionInfo> GetAdvertPositionList(int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetAdvertPositionList(pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.GetAdvertPositionCount();
        }
        ...
        {
            List<AdvertPositionInfo> advertPositionList = new List<AdvertPositionInfo>();
            IDataReader reader = NStore.Core.BMAData.RDBS.GetAllAdvertPosition();
            while (reader.Read())
            {
                AdvertPositionInfo advertPositionInfo = BuildAdvertPositionFromReader(reader);
                advertPositionList.Add(advertPositionInfo);
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateAdvertPosition(advertPositionInfo);
        }
        ...
        public static AdvertPositionInfo GetAdvertPositionById(int adPosId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetAdvertPositionById(adPosId);
            if (reader.Read())
            {
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteAdvertPositionById(adPosId);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateAdvert(advertInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteAdvertById(adId);
        }
        ...
        public static AdvertInfo AdminGetAdvertById(int adId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetAdvertById(adId);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetAdvertList(pageSize, pageNumber, adPosId);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetAdvertCount(adPosId);
        }
        ...
        public static List<AdvertInfo> GetAdvertList(int adPosId, DateTime nowTime)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.GetAdvertList(adPosId, nowTime);
            while (reader.Read())
            {
