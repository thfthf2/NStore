...
namespace NStore.Data
{
    ...
    public partial class Topics
    {
        ...
        {
            NStore.Core.BMAData.RDBS.CreateTopic(topicInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.UpdateTopic(topicInfo);
        }
        ...
        {
            NStore.Core.BMAData.RDBS.DeleteTopicById(topicId);
        }
        ...
        public static TopicInfo AdminGetTopicById(int topicId)
        {
            ...
            IDataReader reader = NStore.Core.BMAData.RDBS.AdminGetTopicById(topicId);
            if (reader.Read())
            {
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetTopicListCondition(sn, title, startTime, endTime);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetTopicListSort(sortColumn, sortDirection);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetTopicList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.AdminGetTopicCount(condition);
        }
        ...
        {
            return NStore.Core.BMAData.RDBS.IsExistTopicSN(topicSN);
        }
        ...
        {
            TopicInfo topicInfo = null;
            IDataReader reader = NStore.Core.BMAData.RDBS.GetTopicByIdAndTime(topicId, nowTime);
            if (reader.Read())
            {
                topicInfo = BuildTopicFromReader(reader);
            }
        ...
        {
            TopicInfo topicInfo = null;
            IDataReader reader = NStore.Core.BMAData.RDBS.GetTopicBySNAndTime(topicSN, nowTime);
            if (reader.Read())
            {
                topicInfo = BuildTopicFromReader(reader);
            }
